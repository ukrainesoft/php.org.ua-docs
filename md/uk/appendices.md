...
-   [Міграція з PHP 8.2.x на PHP 8.3.x](migration83.md)
    -   [Нова функціональність](migration83.new-features.md)
    -   [Нові класи та інтерфейси](migration83.new-classes.md)
    -   [Нові функції](migration83.new-functions.md)
    -   [Нові глобальні константи](migration83.constants.md)
    -   [Зміни, що ламають зворотну сумісність](migration83.incompatible.md)
    -   [Застаріла функціональність](migration83.deprecated.md)
    -   [Інші зміни](migration83.other-changes.md)
    -   [Підтримка Windows](migration83.windows-support.md)
-   [Міграція з PHP 8.1.x на PHP 8.2.x](migration82.md)
    -   [Нова функціональність](migration82.new-features.md)
    -   [Нові функції](migration82.new-functions.md)
    -   [Нові глобальні константи](migration82.constants.md)
    -   [Зміни, що ламають зворотну сумісність](migration82.incompatible.md)
    -   [Застаріла функціональність](migration82.deprecated.md)
    -   [Інші зміни](migration82.other-changes.md)
    -   [Підтримка Windows](migration82.windows-support.md)
