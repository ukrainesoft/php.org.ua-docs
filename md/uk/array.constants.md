...
**`SORT_FLAG_CASE`** може бути об'єднана (побітове АБО) з **`SORT_STRING`**или**`SORT_NATURAL`** для реєстронезалежного сортування рядків. Починаючи з PHP 8.2.0, виконуватиметься лише складання регістрів ASCII.
