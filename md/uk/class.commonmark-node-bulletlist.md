...
final class **CommonMark\Node\BulletList** extends
...
public [\_\_construct](commonmark-node-bulletlist.construct.md)()

public [\_\_construct](commonmark-node-bulletlist.construct.md)(int
`$tight`)
