...
> **Зауваження** :
> 
> Є методи, що дозволяють отримати доступ до *циклу подій за умовчанням*в классе**Ev**(например,[Ev::iteration()](ev.iteration.md) [Ev::depth()](ev.depth.md)и т.д.). Для*користувальницьких циклів* (створених за допомогою **EvLoop::\_\_construct()**) ці значення можуть бути доступні через відповідні властивості та методи класу [EvLoop](class.evloop.md)
> 
