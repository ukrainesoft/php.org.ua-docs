...
*Типовий цикл за замовчуванням* ініціалізується автоматично за допомогою *Єв*. Він доступний за допомогою методів класу [Єв](class.ev.html) або за допомогою методу [EvLoop::defaultLoop()](evloop.defaultloop.html)
