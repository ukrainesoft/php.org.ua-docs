...
`$extension` = **`null`**): ?[PharData](class.phardata.md)

public [compressFiles](phardata.compressfiles.md)(int `$compression`):
void

public [convertToData](phardata.converttodata.md)(?int `$format` =
...
public [decompress](phardata.decompress.md)(?string `$extension` =
**`null`**): ?[PharData](class.phardata.md)
...
public [setDefaultStub](phardata.setdefaultstub.md)(?string `$index` =
...
public [setStub](phardata.setstub.md)(string `$stub`, int `$len` =
-1): bool
