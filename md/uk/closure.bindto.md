...
Створює та повертає нову [анонимную функцию](functions.anonymous.md) з тим же тілом функції та пов'язаними змінними, але з іншим пов'язаним об'єктом або новою областю видимості класу.
...
> **Зауваження**
> 
> Якщо вам необхідно тільки дублювати анонімну функцію, то ви можете замість цього використовувати [клонирование](language.oop5.cloning.md)
