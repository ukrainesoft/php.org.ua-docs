...
Версія платформи .NET для використання з об'єктами [dotnet](class.dotnet.md). Значення параметра - це перші три частини номера версії фреймворку, розділені точками та з префіксом `v`, например`v4.0.30319`
