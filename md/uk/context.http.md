...
За промовчанням використовується значення директиви [defaultsockettimeout](filesystem.configuration.md#ini.default-socket-timeout) із файлу php.ini.
...
> Коли ця обгортка потоку слідує за переадресацією, `wrapper_data`, що повертається функцією [streamgetmetadata()](function.stream-get-meta-data.md), необов'язково містить рядок статусу HTTP, який насправді відноситься до змісту даних за індексом `0`
> 
> ```
> array (
>   'wrapper_data' =>
