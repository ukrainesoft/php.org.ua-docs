...
` <?php$arr = array('один', 'два', 'три', 'чотири', 'стоп', 'п'ять');foreach ($arr as $val) {    if ($val === ' стоп') {        break; /* Тут можна було написати 'break 1;'. */    }    echo "$val<br />
";}/* Використання додаткового аргументу. */$i = 0;while (++$i) {    switch ($i) {         case 5:   |
";  |                                                                                          виходимо<br />
;;                                  
