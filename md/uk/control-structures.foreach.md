...
можливо [налаштувати ітератори об'єктів](language.oop5.iterations.html)

Для того щоб безпосередньо змінювати елементи масиву всередині циклу, змінної `$value` має передувати знак &. У цьому випадку значення буде присвоєно за [засланні](language.references.html)
