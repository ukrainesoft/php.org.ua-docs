...
Описи та приклади застосування цих констант описані у документації функцій [curl\_setopt()](function.curl-setopt.html) [curl\_multi\_setopt()](function.curl-multi-setopt.html) і [curl\_getinfo()](function.curl-getinfo.html)
...
Ця опція недоступна, якщо дозволено [open\_basedir](ini.core.html#ini.open-basedir)
