...
Формат дати та часу у вигляді рядка (string), якому відповідає значення другого аргументу функції. Список варіантів форматування наведено нижче. У більшості випадків, при форматуванні використовуються ті ж символи, що і функції [date()](function.date.md)
...
2.  Застосовується `Mon`, що перекладає дату на `Mon, 10 Aug 2020 01:00:00`. Пояснення щодо ключових слів, таких як `Mon`, описано в розділі [відносні формати](datetime.formats.relative.md)
