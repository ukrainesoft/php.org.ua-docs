...
Об'єкт DateTimeZone надає доступ до трьох різних типів правил часових зон: Зміщення UTC (тип `1`), скорочення часового поясу (тип `2`) та [идентификаторы часовых поясов](timezones.html), опубліковані в базі даних часових поясів IANA (тип `3`
...
Одне з підтримуваних [имён часовых поясов](timezones.html) або значення усунення (+0200) або абревіатура часового поясу (BST).
