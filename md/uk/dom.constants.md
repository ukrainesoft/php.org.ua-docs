...
| --- | --- | --- |
| **`XML_ELEMENT_NODE`** (int) |  | Вузол класу [DOMElement](class.domelement.html) |
| **`XML_ATTRIBUTE_NODE`** (int) |  | Вузол класу [DOMAttr](class.domattr.html) |
| **`XML_TEXT_NODE`** (int) |  | Вузол класу [DOMText](class.domtext.html) |
| **`XML_CDATA_SECTION_NODE`** (int) |  | Вузол класу [DOMCharacterData](class.domcharacterdata.html) |
| **`XML_ENTITY_REF_NODE`** (int) |  | Вузол класу [DOMEntityReference](class.domentityreference.html) |
| **`XML_ENTITY_NODE`** (int) |  | Вузол класу [DOMEntity](class.domentity.html) |
| **`XML_PI_NODE`** (int) |  | Вузол класу [DOMProcessingInstruction](class.domprocessinginstruction.html) |
| **`XML_COMMENT_NODE`** (int) |  | Вузол класу [DOMComment](class.domcomment.html) |
| **`XML_DOCUMENT_NODE`** (int) |  | Вузол класу [DOMDocument](class.domdocument.html) |
| **`XML_DOCUMENT_TYPE_NODE`** (int) |  | Вузол класу [DOMDocumentType](class.domdocumenttype.html) |
| **`XML_DOCUMENT_FRAG_NODE`** (int) |  | Вузол класу [DOMDocumentFragment](class.domdocumentfragment.html) |
| **`XML_NOTATION_NODE`** (int) |  | Вузол класу [DOMNotation](class.domnotation.html) |
