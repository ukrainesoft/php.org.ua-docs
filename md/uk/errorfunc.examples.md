...
Нижче наведено приклад використання можливостей обробки помилок у PHP. Ми визначимо функцію обробки помилок, яка буде записувати інформацію про помилки у файл (використовуючи формат XML), а у разі виникнення критичних помилок, будемо додатково надсилати розробникам листа з повідомленням.
