...
1. [Я зібрав DLL для деяких обчислень. Чи можна запустити цю DLL з PHP?](#faq.com.q1)
...
6. [Чи можна генерувати DLL-файли з PHP-скриптів так, як це можна робити в Perl?](#faq.com.q6)
...
11. [Чи можливо отримати екземпляр, що виконується компонента?](#faq.com.q11)
...
який надає більш ніж один інтерфейс. Що я можу зробити?](#faq.com.q13)
14. [Отже PHP працює з COM, як щодо COM+?](#faq.com.q14)
15. [Якщо PHP може маніпулювати COM-об'єктами, можна уявити
собі використання MTS для управління ресурсами компонентів з'єднанні з PHP?](#faq.com.q15)
...
[com.allow_dcom](com.configuration.md#ini.com.allow-dcom)`=`**`true`**
