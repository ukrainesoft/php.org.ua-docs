...
` #!/usr/bin/php<?phpif ($argc != 2 || in_array($argv[1], array('--help', '-help', '-h', '-?') ))) {?>Це консольний PHP-скрипт, приймає один аргумент. Використання:  <?php echo $argv[0]; ?> <option>  <option> Будь-яке слово, яке ви хотіли би  надрукувати. Опції  --help, -help, -h,  або -? покажуть поточну довідкову інформацію.
