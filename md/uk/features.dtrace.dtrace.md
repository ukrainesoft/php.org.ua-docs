...
**Приклад #1 allprobes.d - трасування всіх статичних зондів PHP за допомогою DTrace**
...
Коли ви побачили все, що хотіли, можна перервати роботу скрипта комбінацією `^C`
