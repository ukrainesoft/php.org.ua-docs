...
Встановлюйте безпечні хешовані одноразові ключі як ключі автологіну за допомогою [setcookie()](function.setcookie.md). Використовуйте безпечне хешування, сильніше ніж SHA-2, наприклад, SHA-256 або вище з випадковими даними з [randombytes()](function.random-bytes.html) або /dev/urandom.
