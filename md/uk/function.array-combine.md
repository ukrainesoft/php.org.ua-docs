...
Починаючи з PHP 8.0.0, видається помилка [ValueError](class.valueerror.md), якщо кількість елементів у `keys` і `values` не збігається. До PHP 8.0.0 натомість видавалася помилка рівня **`E_WARNING`**
