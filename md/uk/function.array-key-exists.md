...
**Пример #1 Пример использования функции**array\_key\_exists()\*\*\*\*
...
**Пример #2 Пример использования функции**array\_key\_exists()\*\* з мовною конструкцією [isset()](function.isset.md)\*\*
