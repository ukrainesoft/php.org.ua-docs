...
**Пример #1 Пример использования**array\_slice()\*\*\*\*
...
**Пример #2 Пример использования**array\_slice()\*\* з одновимірним масивом\*\*
...
**Пример #3 Пример использования**array\_slice()\*\* з масивом із змішаних ключів\*\*
