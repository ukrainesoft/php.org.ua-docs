...
**Пример #1 Пример использования функции**array\_udiff()\*\* з об'єктами класу stdClass\*\*
...
**Пример #2 Пример использования функции**array\_udiff()\*\* з об'єктами класу DateTime\*\*
