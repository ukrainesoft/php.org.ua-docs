...
-   [array\_uintersect\_assoc »](function.array-uintersect-assoc.html)
...
Обчислює розбіжність масивів, використовуючи порівняння даних callback-функцию. Це відрізняється від поведінки [array\_diff()](function.array-diff.html)яка використовує вбудовану функцію для порівняння даних.
