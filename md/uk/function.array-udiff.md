...
Обчислює розбіжність масивів, використовуючи порівняння даних callback-функцию. Це відрізняється від поведінки [arraydiff()](function.array-diff.md)яка використовує вбудовану функцію для порівняння даних.
