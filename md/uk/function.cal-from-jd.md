...
Функция**cal\_from\_jd()** перетворює дату юліанського календаря, задану у параметрі `julian_day`, у дату вказаного у параметрі `calendar` календаря. Підтримувані параметром `calendar`значения:**`CAL_GREGORIAN`** **`CAL_JULIAN`** **`CAL_JEWISH`**и**`CAL_FRENCH`**
...
**Пример #1 Пример использования**cal\_from\_jd()\*\*\*\*
