...
Встановлює заголовок процесу, видимий утилітами **top** і **ps**. Ця функція доступна лише в режимі [CLI](features.commandline.md)
...
**Приклад #1 Приклад використання** cli\_set\_process\_title()\*\*\*\*
