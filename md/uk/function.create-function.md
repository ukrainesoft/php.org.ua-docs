...
Тепер той же код, використовуючи [анонимную функцию](functions.anonymous.html); Зверніть увагу, що код та аргументи більше не містяться в рядках:
...
І знову, той же код з використанням [анонимных функций](functions.anonymous.html). Зверніть увагу, що імена змінних у коді більше не потрібно екранувати, оскільки вони не укладені в рядок.
...
Перетворення наведеного вище коду в [анонимную функцию](functions.anonymous.html)
