...
При валідації паролів повинні використовуватись функції порівняння рядків, стійкі до атаки за часом, для порівняння виведення функції **crypt()** із відомим хешом. У PHP для цього є функція [hashequals()](function.hash-equals.md)
