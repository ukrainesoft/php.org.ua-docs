...
**Приклад #1 Приклад використання** cubrid\_prepare()\*\*\*\*
...
printf("%d соревнований пройдут на олимпиаде 2004, но не в 2000. НаПриклад:\n\n", $row_num);
...
```
27 соревнований пройдут на олимпиаде 2004, но не в 2000. НаПриклад:
