...
` <?php$conn = cubrid_connect("localhost", 33000, "demodb", "dba");printf("
--- Первинний ключ ---
");$pk = cubrid_schema($conn, CUBRID_SCH_PRIMARY_KEY, "game");var_dump($pk);printf("
--- Зовнішні ключи ---
");$fk = cubrid_schema($conn, CUBRID_SCH_IMPORTED_KEYS, "game");var_dump($fk);printf("
--- Атрибут стовпця ---
");$attr==cubrid_schema($conn, CUBRID_SCH_ATTRIBUTE, "stadium", "area");var_dump($attr);cubrid_disconnect($conn);?> `
