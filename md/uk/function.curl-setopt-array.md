...
Встановлює кілька параметрів для сеансу URL. Ця функція корисна під час встановлення великої кількості cURL-параметрів без необхідності постійно викликати [curl\_setopt()](function.curl-setopt.html)
...
Масив (array), що визначає параметри, що встановлюються, і їх значення. Ключі мають бути коректними константами для функції [curl\_setopt()](function.curl-setopt.html) або їх цілими еквівалентами.
...
> **Зауваження**
> 
> Як і при роботі з [curl\_setopt()](function.curl-setopt.html), передача масиву в параметр **`CURLOPT_POST`** закодує всі дані за допомогою *multipart/form-data*, тоді як передача URL-кодованого рядка використовуватиме кодування *application/x-www-form-urlencoded*
