...
**Пример #1 Пример использования функции**date\_parse()\*\* з повним рядком `datetime`\*\*
...
**Пример #2 Пример использования**date\_parse()**с информацией об аббревиатуре часового пояса**
...
**Пример #3 Пример использования**date\_parse()\*\* з інформацією про ідентифікатор часового поясу\*\*
...
**Пример #4 Пример использования**date\_parse()\*\* з мінімальним рядком\*\*
...
**Пример #5 Пример использования**date\_parse()\*\* з відносними форматами\*\*
...
**Пример #6 Пример использования**date\_parse()\*\* з побічними ефектами\*\*
