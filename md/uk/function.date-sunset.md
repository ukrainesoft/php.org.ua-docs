...
`<?php/* calculate the sunset time for Lisbon, PortugalLatitude: 38.4 NorthLongitude: 9 WestZenith ~= 90offset: +1 GMT*/echo date("D?" ', час заходу сонця : ' .date_sunset(time(), SUNFUNCS_RET_STRING, 38.4, -9, 90, 1);?> `
