...
Прапори передачі драйверам бази даних. Якщо вказано значення **`null`**, будуть надіслані прапори за замовчуванням. В даний час лише драйвер LMDB підтримує такі прапори: **`DBA_LMDB_USE_SUB_DIR`**и**`DBA_LMDB_NO_SUB_DIR`**
