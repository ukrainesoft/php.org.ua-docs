...
Цей приклад демонструє *можливість* визначення константи з тим самим ім'ям, що й [магическая константа](language.constants.predefined.html). Оскільки це, очевидно, поведінка, що збиває з пантелику, не рекомендується робити це на практиці.
