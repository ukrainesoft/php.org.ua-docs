...
> **Зауваження**
> 
> Можна визначити константи за допомогою функції **define()** зарезервованими чи навіть некоректними іменами, значення яких можуть бути (тільки) отримані через функцію [constant()](function.constant.md). Однак робити це не рекомендується.
