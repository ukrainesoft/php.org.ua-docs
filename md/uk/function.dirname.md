...
> **Зауваження** :
> 
> Функция**dirname()** наївно оперує виключно вихідним рядком та не враховує реальну файлову систему чи компоненти шляху типу " `.. .` ".

**Застереження**

В Windows**dirname()** передбачає поточну встановлену кодову сторінку, тому щоб бачити правильне ім'я каталогу з шляхами багатобайтових символів, необхідно встановити відповідну кодову сторінку. Якщо `path` містить символи, неприпустимі для поточної кодової сторінки, поведінка \*\*dirname()\*\*не определено.
...
**Приклад #1 Приклад использования функции**dirname()\*\*\*\*
