...
Цю функцію можна використовувати замість [easter\_date()](function.easter-date.html) для розрахунку дати Великодня для дат, що виходять за рамки діапазону тимчасових міток Unix (з 1970 до 2037 року).
