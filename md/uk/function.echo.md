...
`echo` має також коротку форму, що представляє собою знак рівності, наступний безпосередньо за тегом, що відкриває. Цей скорочений синтаксис працює навіть із вимкненим параметром конфігурації [shortopentag](ini.core.md#ini.short-open-tag)
