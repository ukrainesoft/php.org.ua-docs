...
`<?php// Приклад висновку: В останній раз звернення до файлу somefile.txt було вироблено: December 29 2002 22:16:23.$filename = ' В останній раз звернення до файлу $ filename було зроблено: "". date("F|d|Y|H:i:s.",|fileatime($filename));}?> `
