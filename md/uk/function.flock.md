...
Блокування також знімається за допомогою [fclose()](function.fclose.md) або коли `stream` збирається збирачем сміття.
...
> **Зауваження**
> 
> Може використовуватись лише на дескрипторах локальних файлів, повернутих функцією [fopen()](function.fopen.md), або файлових дескрипторах користувача потоків, що реалізують метод [streamWrapper::streamlock()](streamwrapper.stream-lock.html)
