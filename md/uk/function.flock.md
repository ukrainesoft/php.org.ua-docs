...
> **Зауваження**
> 
> Може використовуватись лише на дескрипторах локальних файлів, повернутих функцією [fopen()](function.fopen.html), або файлових дескрипторах користувача потоків, що реалізують метод [streamWrapper::stream\_lock()](streamwrapper.stream-lock.html)
