...
> **Зауваження**
> 
> Може використовуватись лише на дескрипторах локальних файлів, повернутих функцією [fopen()](function.fopen.md), або файлових дескрипторах користувача потоків, що реалізують метод [streamWrapper::streamlock()](streamwrapper.stream-lock.md)
