...
Значення параметра `flags` може бути будь-яка комбінація наступних прапорів, об'єднаних за допомогою [бінарного оператора АБО (|)](language.operators.bitwise.html)
