...
-   став доступний пакет або минув[час очікування сокету](function.socket-set-timeout.md)(для мережевих потоків)
...
На системах, які розрізняють бінарні та текстові файли (наприклад, Windows), файл має бути відкритий з використанням прапора 'b' у параметрі mode функції [fopen()](function.fopen.md)
...
> **Зауваження** :
> 
> Якщо ви просто хочете отримати вміст файлу у вигляді рядка, використовуйте [file\_get\_contents()](function.file-get-contents.md), оскільки ця функція набагато продуктивніша, ніж описаний вище код.
