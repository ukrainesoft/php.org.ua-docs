...
Збирає статистичну інформацію про відкритий файл за файловим покажчиком `stream`. Ця функція схожа на [stat()](function.stat.html), за винятком того, що вона працює з відкритим файловим покажчиком, а не ім'ям файлу.
...
Повертає масив із статистичною інформацією файлу; формат масиву докладно описано на сторінці опису функції [stat()](function.stat.html). Повертає **`false`** у разі виникнення помилки.
