...
Не використовуйте **getimagesize()** для перевірки, що файл є зображенням. Для цього використовуйте модуль [Fileinfo](book.fileinfo.md)
...
Індекс 2 містить одну з констант типу зображення [IMAGETYPEXXX](image.constants.md)
