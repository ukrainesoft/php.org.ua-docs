...
Повертає позитивне значення, якщо `a > b`, нуль, якщо `a = b` і
...
`<?php$cmp1 = gmp_cmp("1234", "1000"); // більше$cmp2 = gmp_cmp("1000", "1234"); // менше $cmp3 = gmp_cmp("1234", "1234"); // рівніecho "$cmp1 $cmp2 $cmp3
";?> `
