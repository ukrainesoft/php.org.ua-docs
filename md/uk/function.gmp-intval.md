...
Ця функція повертає придатний для подальшого застосування результат тільки якщо число вписується в діапазон можливих чисел типу PHP integer (тобто, довге ціле зі знаком). Якщо потрібно просто вивести GMP на екран, використовуйте [gmpstrval()](function.gmp-strval.md)
