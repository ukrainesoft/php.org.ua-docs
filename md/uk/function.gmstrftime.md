...
Повертає рядок, відформатований згідно з вказаним форматом та з використанням тимчасової мітки з параметра `timestamp` або поточного локального часу, якщо тимчасова мітка не була вказана. Назви місяців, днів тижня та інших мовнозалежних рядків будуть показані з урахуванням налаштувань поточної локалі, встановлених за допомогою функції [setlocale()](function.setlocale.md). У разі виникнення помилки повертає **`false`**
