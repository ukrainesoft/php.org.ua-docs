...
**Приклад #1 Приклад використання** gnupg\_getengineinfo()\*\* у процедурному стилі\*\*
...
**Приклад #2 Приклад використання** gnupg\_getengineinfo()\*\* в об'єктно-орієнтованому стилі\*\*
