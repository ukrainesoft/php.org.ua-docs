...
> **Зауваження** :
> 
> Используйте[gzrewind()](function.gzrewind.md), щоб перемістити вказівник на позицію на початок файлу, якщо ви вже записували дані до нього.
...
Кількість стиснутих символів, прочитаних з `gz` та переданих на вхід.
