...
**headers_sent**(string `&$filename` = **`null`**, int `&$line` =
**`null`**): bool
...
HTTP-заголовки. Іншим варіантом є використання [буферизації виводу](ref.outcontrol.md).
...
" .           "Неможливо перенаправити, будь ласка, передіть по цієї <a " .          "href=\"http://www.example.com>
";   exit;}?> `
