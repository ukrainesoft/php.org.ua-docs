...
Якщо параметр `return`равен\*\*`true`\*\*, замість виведення у вигляді рядка повертається код з підсвічуванням синтаксису. В іншому випадку повертає \*\*`true`**или**`false`\*\*в случае возникновения ошибки.
...
**Пример #1 Пример использования функции**highlight\_string()\*\*\*\*
