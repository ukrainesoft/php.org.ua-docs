...
`<?php$str = "A 'quote' is <b>bold</b>";// виводить: A 'quote' is <b>bold</b>echo htmlentities($str);// виводить : A 'quote' is <b>bold</b>echo htmlentities($str, ENT_QUOTES);?> `

**Приклад #2 Використання **`ENT_IGNORE`****

` <?php$str = "\x8F!!!";// Виводить пусту рядокecho htmlentities($str, ENT_QUOTES, "UTF-8");// Виводить "!!!"echo htmlentities($str, ENT_QUES| ENT_IGNORE, "UTF-8");?> `
