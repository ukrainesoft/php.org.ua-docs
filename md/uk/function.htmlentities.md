...
За наявності у вхідному параметрі `string` неприпустимої послідовності символів у заданому кодуванні `encoding`, буде повернено порожній рядок, якщо не встановлено прапори **`ENT_IGNORE`** або **`ENT_SUBSTITUTE`**
...
**Приклад #2 Использование**`ENT_IGNORE`\*\*\*\*
