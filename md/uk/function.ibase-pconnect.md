...
Принцип роботи **ibasepconnect()** дуже схожий [ibaseconnect()](function.ibase-connect.html) з двома основними відмінностями.
...
По-друге, з'єднання з сервером InterBase не буде закрито після закінчення скрипту. Натомість посилання залишиться відкритим для використання надалі ([ibaseclose()](function.ibase-close.html) не закриватиме посилання, встановлені **ibasepconnect()**). Тому цей тип посилання називається "постійним".
