...
` <?php$timestamp = strtotime('1st January 2004'); //1072915200// це виведе рік в 2-х знаковому представленні// оскільки перша цифра "0", буде виведено//тільки "4"echo idate('y', $
