...
`<?php$im = imagecreate(100, 100);$string = 'PHP';$bg = imagecolorallocate($im, 255, 255, 255);$black = imagecolorallocate($im, 0, 0, ;// друкує чорний символ "P" в лівому верхньому кутуimagechar($im, 1, 0, 0, $string, $black);header('Content-type: image/png');imagepng($im);? > `
