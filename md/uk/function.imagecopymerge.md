...
який може змінюватись від 0 до 100. Коли `pct` = 0, накладення не
...
`<?php// Створення зображень$dest = imagecreatefromgif('php.gif');$src = imagecreatefromgif('php.gif');// Копіювання і накладанняimagecopymerge($dest, $src, 10, 0 0, 100, 47, 75);
