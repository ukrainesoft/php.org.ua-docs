...
`pct` = 100 поведінка функції ідентична
...
` <?php//Створення зображень$dest = imagecreatefromgif('php.gif');$src = imagecreatefromgif('php.gif');// Копіювання і накладання - Сірий = 20%image$$ 10, 10, 0, 0, 100, 47, 20); ;?> `
