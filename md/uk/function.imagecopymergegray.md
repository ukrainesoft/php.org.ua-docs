...
Функція працює аналогічно [imagecopymerge()](function.imagecopymerge.html) за винятком того, що при накладенні вона зберігає насиченість кольору вихідного зображення шляхом перетворення кольорів пікселів кінцевого зображення в сірому градації перед копіюванням.
