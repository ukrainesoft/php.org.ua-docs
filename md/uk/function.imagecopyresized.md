...
Зображення буде виведено зі зменшеним розміром. Якщо потрібно отримати зображення у найкращій якості, використовуйте функцію [imagecopyresampled()](function.imagecopyresampled.html)
