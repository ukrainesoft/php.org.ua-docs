...
**imagecopyresized()** копіює прямокутну ділянку одного зображення на інше зображення . `dst_image`\- результирующее изображение,`src_image` - Ідентифікатор вихідного зображення.
...
Зображення буде відображено зі зменшеним розміром. Якщо потрібно отримати зображення у найкращій якості, використовуйте функцію [imagecopyresampled()](function.imagecopyresampled.md)
