...
` <?php$cropped = imagecropauto($im, IMG_CROP_DEFAULT);if ($cropped !== false) { // в випадку повернення нового об'єкту зображення     images // ми знищуємо вихідне зображення    $im = $cropped; // і призначаємо обрізане зображення в $im}?> `
