...
`$method` = **`IMG_BILINEAR_FIXED`**): bool
...
` <?php// Завантаження зображення$im = imagecreate(500, 500);// За мовчанням інтерполяція IMG_BILINEAR_FIXED, перемкніться// на використання фільтра 'Мітчела | im ...?> `
