...
**imagesetstyle()** задає стиль, який використовуватиметься функціями малювання ліній (такими як [imageline()](function.imageline.md) і [imagepolygon()](function.imagepolygon.md)) при задании специального цвета\*\*`IMG_COLOR_STYLED`**или**`IMG_COLOR_STYLEDBRUSHED`\*\*
