...
`<?php// Створення зображення 100*30$im = imagecreate(100, 30);// Білий фон, синій текст$bg = imagecolorallocate($im, 255, 255, $5 , 0, 0, 255);// Напис|у лівому верхньому кутиimagestring($im, 5, 0, 0, 'Hello world!', $textcolor); ;imagepng($im);imagedestroy($im);?> `
