...
`<?php//Створення зображення 100*100$im = imagecreatetruecolor(100, 100);// Напис$textcolor = imagecolorallocate($im, 0xFF, 0xFF, 0xFF) 'gd library', $textcolor);// Збереження зображенняimagepng($im, './stringup.png');imagedestroy($im);?> `
