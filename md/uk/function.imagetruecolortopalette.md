...
` <?php// Створення повнокольорового зображення$im = imagecreatetruecolor(100, 100);// Перетворення в палітрове (255 квітів) без згладжуванняimagetruecolortopalette($| paletteimage.png');imagedestroy($im);?> `
