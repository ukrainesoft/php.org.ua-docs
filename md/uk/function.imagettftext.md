...
> **Зауваження**
> 
> До PHP 8.0.0 [imagefttext()](function.imagefttext.md) - це розширений варіант **imagettftext()**, який додатково підтримує `extrainfo`. Починаючи з PHP 8.0.0, **imagettftext()** є псевдонімом [imagefttext()](function.imagefttext.md)
