...
Іменовані сутності, на зразок ©, не підтримуються. Використовуйте функцію [htmlentitydecode()](function.html-entity-decode.html), щоб декодувати їх у рядках UTF-8.
