...
-   \*\*`LATT_UNMARKED`**\- Ця скринька не помічена, тобто. у ньому немає нових листів. Якщо один із прапорів**`MARKED`**или**`UNMARKED`\*\*виставлений - вважаєте, що сервер підтримує цей функціонал.
...
**Пример #1 Пример использования**imap\_getmailboxes()\*\*\*\*
