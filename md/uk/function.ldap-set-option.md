...
`<?php//$$ds - дійсний ідентифікатор зв'язку з LDAP-сервером// елемент управління з відсутнім значенням$ctrl1 = array("oid" => "1.2.752. / iscritical за мовчанням FALSE$ctrl2 = array("oid" => "1.2.752.58.1.10", "value" => "magic");// проба встановлення оба ($ctrl1, $ctrl2))) {    echo "Не удалося встановити серверні елементи управління";}?> `
