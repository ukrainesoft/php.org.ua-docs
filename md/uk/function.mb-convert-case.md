...
**Приклад #1 Приклад використання функції** mb\_convert\_case()\*\*\*\*
...
**Приклад #2 Приклад використання функції** mb\_convert\_case()\*\* з нелатинський текстом у кодуванні UTF-8\*\*
