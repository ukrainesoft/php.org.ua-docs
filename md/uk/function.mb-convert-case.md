...
` <?php$str = "у мери був маленький ягня і вона його дуже любила";$str = mb_convert_case($str, MB_CASE_UPPER, "UTF-8");echo $; // Виведе У МЕРІ БУВ МАЛЕНЬКИЙ ЯГНЯ  І ВОНА ЙОГО ДУЖЕ¦ЛЮБИЛА$str = mb_convert_case($str, MB_CASE_TITLE, "UTF-8"); // Виведе У Мері Було Маленьке Ягня І Вона Його Дуже Любила?> `

**Приклад #2 Приклад використання **mb_convert_case()** з нелатинським
UTF-8 текстом**

` <?php$str = "Τάχιστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός";$str ;str$$| // Выведет ΤΆΧΙΣΤΗ ΑΛΏΠΗΞ ΒΑΦΉΣ ΨΗΜΈΝΗ ΓΗ, ΔΡΑΣΚΕΛΊΖΕΙ ΥΠΈΡ ΝΩΘΡΟΎ ΚΥΝΌΣ$str = mb_convert_case($str, MB_CASE_TITLE, "UTF-8");echo $str; // Виведе Τάχιστη Αλώπηξ Βαφήσ Ψημένη Γη, Δρασκελίζει Υπέρ ΝωθρούΚυνόσ?> `
