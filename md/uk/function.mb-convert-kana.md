...
` <?php/* Перетворення всіх символів "kana" в "zen-kaku" "kata-kana" */$str = mb_convert_kana($str, "KVC");/* Перетворення "han-kaku"ka " в "zen-kaku" "kata-kana"   і "zen-kaku" літерно-цифрових символів в "han-kaku" */$str = mb_convert_kana($str, "KVa");?> `
