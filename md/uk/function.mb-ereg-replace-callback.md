...
Поведінка цієї функції майже ідентична з функцією [mb\_ereg\_replace()](function.mb-ereg-replace.html), за винятком того, що замість рядка заміни `replacement` необхідно визначати функцію `callback`
