...
**Пример #1 Пример использования функции**mb\_ereg\_replace\_callback()\*\*\*\*
...
**Пример #2 Пример использования функции**mb\_ereg\_replace\_callback()\*\* з анонімною функцією\*\*
