...
Цей параметр екранується функцією [escapeshellcmd()](function.escapeshellcmd.html) автоматично, щоб запобігти запуску інших команд . [escapeshellcmd()](function.escapeshellcmd.html) запобігає запуску команд, але допускає додавання додаткових аргументів, тому для забезпечення безпеки потрібно перевіряти цю опцію.

Так як [escapeshellcmd()](function.escapeshellcmd.html) застосовується автоматично, не можна використовувати деякі символи, допустимі в email-адресах. Не можна використовувати функцію [mail()](function.mail.html) для програм, які потребують використання таких символів.
