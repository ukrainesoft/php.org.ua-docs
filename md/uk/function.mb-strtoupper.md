...
` <?php$str = "У Мері Був Маленький Ягня і Вона Його Дуже ЛЮБИЛА";$str = mb_strtoupper($str);echo $str; // Виведе У МЕРІ БУЛО МАЛЕНЬКИЙ ЯГНЯ  І ВОНА ЙОГО ДУЖЕ¦ЛЮБИЛА?>

**Приклад #2 Приклад використання **mb_strtoupper()** з нелатинськими
літерами**

` <?php$str = "Τάχιστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός";$str |strstr| // Виведе ΤΆΧΙΣΤΗ ΑΛΏΠΗΞ ΒΑΦΉΣ ΨΗΜΈΝΗ ΓΗ, ΔΡΑΣΚΕΛΊΖΖΕΙ ΥΠΈΡ???
