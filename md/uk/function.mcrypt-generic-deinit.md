...
Ця функція перериває шифрування, задане дескриптором шифрування (`td`). Вона очищує всі буфери, але не закриває модуль. Для закриття модуля ви повинні самостійно викликати [mcrypt\_module\_close()](function.mcrypt-module-close.html), або його буде автоматично закрито після завершення роботи скрипта.
