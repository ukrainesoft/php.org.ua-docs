...
Правильніше використовуватиме [mcryptencgetkeysize()](function.mcrypt-enc-get-key-size.md), тому що вона повертає результат по існуючому дескриптору шифрування, отриманого за допомогою [mcryptmoduleopen()](function.mcrypt-module-open.md)
