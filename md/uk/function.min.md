...
navigation:
  - function.max.md: « max
  - function.mt-getrandmax.md: мтgetrandmax »
  - index.md: PHP Manual
...
Будьте обережні під час передачі аргументів різних типів, оскільки результат [max()](function.max.md) може вас здивувати.
...
// При сравнении Масивов, разной длины - min вернёт самый короткий
$val = max(array(2, 2, 2), array(1, 1, 1, 1)); // array(2, 2, 2)

// При указании нескольких Масивов, они сравниваются полностью
// в нашем примере: 2 == 2, но 4 < 5
$val = min(array(2, 4, 8), array(2, 5, 1)); // array(2, 4, 8)

// При указании Масива и не Масива,
