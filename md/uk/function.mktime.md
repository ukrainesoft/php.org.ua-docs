...
` <?php$lastday = mktime(0, 0, 0, 3, 0, 2000);echo strftime("Останній день лютого 2000 г.: %d", $lastday);$lastday 0, 4, -31, 2000);echo strftime("Останній день лютого 2000 г.: %d", $lastday);?> `
