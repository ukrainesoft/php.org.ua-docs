...
-   [mysqliaffectedrows()](mysqli.affected-rows.html)
...
> 
> Щоб отримати кількість рядів, повернутих SELECT-запитом, використовуйте функцію [mysqlnumrows()](function.mysql-num-rows.html)
