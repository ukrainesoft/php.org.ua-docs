...
navigation:
  ...
  - function.mysql-drop-db.md: mysqldropdb »
  - index.md: PHP Manual
  - ref.mysql.md: MySQL
title: mysqlдбquery
---
...
-   [mysqliselectdb()](mysqli.select-db.md) then the query
