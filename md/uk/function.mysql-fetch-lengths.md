...
-   [mysqlifetchlengths()](mysqli-result.lengths.html)
...
**mysqlfetchlengths()** повертає довжини кожного поля, що міститься в останньому ряду, обробленому функціями [mysqlfetchrow()](function.mysql-fetch-row.html) [mysqlfetchassoc()](function.mysql-fetch-assoc.html) [mysqlfetcharray()](function.mysql-fetch-array.html) і [mysqlfetchobject()](function.mysql-fetch-object.html) у масиві, що починається з 0.
