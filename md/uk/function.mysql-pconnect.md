...
-   [mysqliconnect()](function.mysqli-connect.html) з `p:` префіксом хоста
-   [PDO::construct()](pdo.construct.html) з опцією драйвера **`PDO::ATTR_PERSISTENT`**
...
**mysqlpconnect()** працює аналогічно [mysqlconnect()](function.mysql-connect.html) із двома важливими відмінностями.
...
По-друге, з'єднання з SQL-сервером не буде закрито, коли робота скрипта закінчиться. Натомість, воно залишиться робочим для майбутнього використання ([mysqlclose()](function.mysql-close.html) також не закриває постійні з'єднання, відкриті **mysqlpconnect()**
...
> **Зауваження**
> 
> Зверніть увагу, що з'єднання такого типу працюють тільки, якщо PHP встановлений як модуль. За додатковою інформацією звертайтесь до розділу "[Постійні з'єднання з базами даних](features.persistent-connections.html)".
