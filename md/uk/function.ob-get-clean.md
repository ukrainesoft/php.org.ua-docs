...
Функція викликає обробник виведення (з прапорами **`PHP_OUTPUT_HANDLER_CLEAN`** і **`PHP_OUTPUT_HANDLER_FINAL`**), видаляє повернутий їм значення, повертає вміст активного буфера виведення і відключає активний буфер виведення.
