...
Якщо необхідно прикріпити змінну абстрактного типу (LOB/ROWID/BFILE), слід попередньо використовувати [ocinewdescriptor()](function.oci-new-descriptor.html). Параметр `length` не використовується для абстрактних типів і повинен бути встановлений -1.
...
-   **`SQLT_RSET`** - для курсорів, створених функцією [ocinewcursor()](function.oci-new-cursor.html)
