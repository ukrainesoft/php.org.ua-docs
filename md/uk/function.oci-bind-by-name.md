...
Якщо необхідно прикріпити змінну абстрактного типу (LOB/ROWID/BFILE), слід попередньо використовувати [oci\_new\_descriptor()](function.oci-new-descriptor.html). Параметр `length` не використовується для абстрактних типів і повинен бути встановлений -1.
...
-   **`SQLT_RSET`** - для курсорів, створених функцією [oci\_new\_cursor()](function.oci-new-cursor.html)
...
Не використовуйте [addslashes()](function.addslashes.html) одночасно з **ocibindбname()**, так як лапок бути не повинно. Всі зазначені лапки будуть записані до бази даних, тому що **ocibindбname()** вставляє дані дослівно і не видаляє лапки або символи екранування.
