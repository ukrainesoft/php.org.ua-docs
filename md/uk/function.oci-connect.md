...
**Пример #1 Пример использования**oci\_connect()**с синтаксисом Easy Connect**
...
**Пример #2 Пример использования**oci\_connect()**используя имя Network Connect**
...
**Пример #3 Пример использования**oci\_connect()\*\* з використанням певного набору символів\*\*
