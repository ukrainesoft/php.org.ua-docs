...
**Пример #1**oci\_execute()\*\* під час виконання запитів\*\*
...
**Пример #2**oci\_execute()\*\* без вказівки певного режиму\*\*
...
**Пример #3**oci\_execute()**с**`OCI_NO_AUTO_COMMIT`\*\*\*\*
...
**Пример #4**oci\_execute()\*\* з різними режимами\*\*
...
**Пример #5**oci\_execute()**с**`OCI_DESCRIBE_ONLY`\*\*\*\*
