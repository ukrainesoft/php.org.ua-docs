...
Вам не слід забувати про те, що Oracle повертає імена полів у верхньому регістрі, тому імена атрибутів об'єкта будуть також у верхньому регістрі. Використовуйте функцію [var\_dump()](function.var-dump.html) по відношенню до отриманого об'єкта для доступу до атрибутів.
