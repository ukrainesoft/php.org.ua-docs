...
Функція **ocisetprefetchлоб()** викликається до виклику [oci\_execute()](function.oci-execute.html). Якщо функція не була викликана, використовується значення [oci8.prefetch\_lob\_size](oci8.configuration.html#ini.oci8.prefetch-lob-size)
...
-   INI-опція [oci8.prefetch\_lob\_size](oci8.configuration.html#ini.oci8.prefetch-lob-size)