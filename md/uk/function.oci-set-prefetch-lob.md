...
Функція **ocisetprefetchлоб()** викликається до виклику [ociexecute()](function.oci-execute.html). Якщо функція не була викликана, використовується значення [oci8.prefetchlobsize](oci8.configuration.html#ini.oci8.prefetch-lob-size)
