...
-   Для постійних з'єднань: [odbcpconnect()](function.odbc-pconnect.md) - Відкриває постійне з'єднання з базою даних
