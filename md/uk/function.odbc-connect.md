...
-   Для постійних з'єднань: [odbc\_pconnect()](function.odbc-pconnect.html) - Відкриває постійне з'єднання з базою даних