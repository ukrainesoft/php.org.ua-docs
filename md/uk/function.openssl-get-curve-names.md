...
opensslgetcurvenames — список доступних імен кривих для ECC
...
Повертає список доступних кривих імен для використання в еліптичній криптографії (ECC) для операцій з відкритим/закритим ключем. Дві найбільш стандартизовані/підтримувані криві: *prime256v1* (NIST P-256) та *secp384r1* (NIST P-384).
...
Масив з доступними іменами кривих або **`false`** у разі виникнення помилки.

### Приклади

**Приклад #1 Приклад використання **opensslgetcurvenames()****
