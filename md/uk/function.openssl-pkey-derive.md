...
`$private_key`, int `$key_length` = 0): string\|false
...
` <?php// Загрузка закрытого ключа$priv = openssl_pkey_get_private("-----BEGIN PRIVATE KEY----- -----END PRIVATE KEY-----");// Загрузка открытого ключа$pub = openssl_pkey_get_public("-----BEGIN PUBLIC KEY- ----MIICJDCCARcGCSqGSIb3DQEDATCCAQgCggEBAJLxRCaZ933uW+AX -----END PUBLIC KEY-----");// Выводит шестнадцатеричную версию виробленого ключаecho bin2hex(openssl_pkey_derive($pub,$priv)); `
