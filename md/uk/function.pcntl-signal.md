...
Оброблювач сигналу. Це може бути або [callable](language.types.callable.md), вказівник на функцію, яка буде запущена для обробки сигналу, або значення однієї з глобальних констант: **`SIG_IGN`** або **`SIG_DFL`**, які, відповідно, або призведуть до ігнорування сигналу або відновлення оброблювача за замовчуванням.

Якщо передано тип [callable](language.types.callable.md), він повинен мати таку сигнатуру:
