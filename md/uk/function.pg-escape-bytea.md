...
`<?php  // Підключення к базі даних $dbconn = pg_connect('dbname=foo'); // Читання бінарного файлу  $data = file_get_contents('image1.jpg'); // Екранування спецсимволів у рядку з двійковими даними  $escaped = pg_escape_bytea($data); // Вставка в таблицю бази даних  pg_query("INSERT INTO gallery (name, data) VALUES ('Pine trees', '{$escaped}')");?> `
