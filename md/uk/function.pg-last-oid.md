...
`<?php  // Підключення к базі даних  pg_connect("dbname=mark host=localhost"); // Створення тестової таблиці pg_query("CREATE TABLE test (a INTEGER) WITH OIDS"); // Вставка даних в таблицю  $res = pg_query("INSERT INTO test VALUES (1)"); $oid= pg_last_oid($res);?> `
