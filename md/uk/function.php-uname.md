...
Нижче наведено декілька [Предопределённых PHP-констант](language.constants.predefined.html), які можуть виявитися корисними:
