...
php\_uname — Повертає інформацію про операційну систему, на якій запущено PHP
...
**Приклад #1 Декілька прикладів використання **php\_uname()****
