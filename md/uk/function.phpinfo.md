...
> **Зауваження**
> 
> У версіях PHP до 5.5 частина інформації не виводиться, якщо налаштування [exposephp](ini.core.md#ini.expose-php) встановлена ​​в `off`. Це PHP та Zend логотипи та інформація про розробників.
