...
posix\_getpwuid — Повертає інформацію про користувача, використовуючи його ID
...
| gid | Ідентифікатор групи користувача. Використовуйте функцію [posix\_getgrgid()](function.posix-getgrgid.md) для отримання імені групи та списку користувачів- її членів. |
