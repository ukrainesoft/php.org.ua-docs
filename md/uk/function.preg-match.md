...
Не використовуйте функцію **pregmatch()**, якщо необхідно перевірити наявність підрядка у заданому рядку. Використовуйте для цього [strpos()](function.strpos.html) оскільки вона виконає це завдання набагато швидше.
