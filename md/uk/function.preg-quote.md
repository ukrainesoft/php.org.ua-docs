...
` <?php$keywords = '$40 за g3/400';$keywords = preg_quote($keywords, '/');echo $keywords; // повертає \$40 за g3\/400?> `

**Приклад #2 Виділення курсивом слова в тексті**

` <?php// У даному прикладі preg_quote($word) використовується, щоб// уникнути трактування символу '*' якспец. символа.$textbody = "Эту книгу *очень* тяжело найти.";$word = "*очень*";$textbody = preg_replace ("/" . preg_quote($word, '/') . "/",                          "< i>" . $word . "</i>",                          $textbody);?> `
