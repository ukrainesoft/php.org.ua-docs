...
procgetstatus — Отримати інформацію про процес, відкритий [procopen()](function.proc-open.html)
...
**procgetstatus()** отримує дані про процес, відкритий за допомогою функції [procopen()](function.proc-open.html)

### Список параметрів

`process`

Дескриптор типу resource, відкритий за допомогою [procopen()](function.proc-open.html), що буде досліджуватися.
...
| --- | --- | --- |
| command | string | Рядок з командою, яка була передана функції [procopen()](function.proc-open.html) |
