...
**procopen()** аналогічна [popen()](function.popen.html), але надає набагато більше контролю за виконанням програми.
...
> **Зауваження**
> 
> Якщо потрібний односпрямований канал процесу, використовуйте функцію [popen()](function.popen.html), оскільки вона значно простіша у використанні.
