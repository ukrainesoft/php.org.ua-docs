...
Поміщає раніше завантажене зображення на сторінку. Зображення можна масштабувати. Якщо зображення теж необхідно повернути, потрібно буде спочатку повернути систему координат за допомогою [псrotate()](function.ps-rotate.html)
...
Ідентифікатор ресурсу зображення, повернутий [псopenimage()](function.ps-open-image.html) або [псopenimagefile()](function.ps-open-image-file.html)
