...
title: rnp\_op\_sign\_detached
origin_hash: ddf652f5224dc9f1fa9671347921941ca401ea50
---
# rnp\_op\_sign\_detached

(PECL rnp >= 0.1.1)

rnp\_op\_sign\_detached — Виконує операцію підписання, повертає від'єднаний підпис (підписи)
...
Повертає дані з від'єднаним підписом (підписами) у разі успішного виконання або \*\*`false`\*\*в случае возникновения ошибки.
