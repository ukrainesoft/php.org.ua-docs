...
` <?php$out = fopen('php://stdout','w');fwrite($out, 'Just forgot a lettr.');// Перемістити курсор на дві позиції назадfwrite($out, " [2D");// Вставляє один пробіл, зсуваючи існуючий текст вправо -> Просто забули букву. fwrite ($ out, "" [1 @");
