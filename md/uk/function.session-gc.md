...
**Пример #1 Пример использования**session\_gc()\*\* у диспетчерах завдань, таких як cron\*\*
...
**Пример #2 Пример использования**session\_gc()\*\* у скрипті, доступному користувачеві\*\*
