...
Користувачі Windows знайдуть корисну інформацію про значення `locales` на веб-сайті Microsoft MSDN. Підтримувані мови перераховані в [» документації за мовними рядками](http://msdn.microsoft.com/en-us/library/39cwe7zf%28v=vs.90%29.aspx), а значення країн/регіонів у [» документации по строкам стран/регионов](http://msdn.microsoft.com/en-us/library/cdax410z%28v=vs.90%29.aspx)
