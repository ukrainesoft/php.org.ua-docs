...
У разі успішного виконання **shmopopen()** повертає екземпляр [Shmop](class.shmop.md), який може бути використаний для доступу до зарезервованої ділянці пам'яті. У разі виникнення помилки повертає **`false`**
