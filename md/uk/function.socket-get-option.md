...
Екземпляр [Socket](class.socket.md), створений за допомогою [socketcreate()](function.socket-create.html) або [socketaccept()](function.socket-accept.html)
...
| **`SO_LINGER`** |  |  |
| Повідомляє, чи буде `socket` зупинятися на [socketclose()](function.socket-close.html), якщо дані є. За умовчанням, коли сокет закритий, він спробує надіслати всі ненадіслані дані. У разі сокету, орієнтованого на підключення, [socketclose()](function.socket-close.html) чекатиме, поки його одноранговий вузол підтвердить дані. |  |  |
