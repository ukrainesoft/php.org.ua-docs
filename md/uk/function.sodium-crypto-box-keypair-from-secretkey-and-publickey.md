...
Функция существует для удовлетворения требований API, наПриклад**crypto\_box()**. Передайте секретний ключ однієї сторони та відкритий інший ключ і ви отримаєте ключову пару для комунікації.
