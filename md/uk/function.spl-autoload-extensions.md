...
Ця функція може задавати розширення файлів, у яких callback-функція [autoload()](function.autoload.html) шукатиме класи та інтерфейси . [splautoload()](function.spl-autoload.html) буде викликати функцію autoload та передавати йому ці розширення. Також ця функція може виводити вже зареєстровані розширення файлів.
...
Список перелічених через кому розширень файлів для функції [splautoload()](function.spl-autoload.html)
