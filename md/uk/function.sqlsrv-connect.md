...
підтримуваних ключів дивіться у розділі [» Параметри підключення SQLSRV](http://msdn.microsoft.com/en-us/library/ff628167.aspx).
...
додаткову інформацію дивіться розділ [» Пул з'єднань SQLSRV](http://msdn.microsoft.com/en-us/library/cc644930.aspx).
