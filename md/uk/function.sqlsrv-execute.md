...
sqlsrvexecute — Виконує запит, підготовлений за допомогою [sqlsrvprepare()](function.sqlsrv-prepare.md)
...
Виконує запит, підготовлений за допомогою [sqlsrvprepare()](function.sqlsrv-prepare.md). Функція ідеально підходить для багаторазового виконання підготовленого запиту з різними параметрами.

### Список параметрів

`stmt`

Ресурс оператора, що повертається [sqlsrvprepare()](function.sqlsrv-prepare.md)
...
У цьому прикладі показано, як підготувати оператор за допомогою [sqlsrvprepare()](function.sqlsrv-prepare.md) та повторно виконати його кілька разів (з різними значеннями параметрів) за допомогою **sqlsrvexecute()**
