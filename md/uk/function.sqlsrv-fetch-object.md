...
При використанні набору результатів, що містить кілька стовпців з однаковим ім'ям, можливо краще використовувати [sqlsrv\_fetch\_array()](function.sqlsrv-fetch-array.html) або комбінацію [sqlsrv\_fetch()](function.sqlsrv-fetch.html) і [sqlsrv\_get\_field()](function.sqlsrv-get-field.html)
