...
Робить наступний рядок у наборі результатів, доступних для читання. Використовуйте [sqlsrvgetfield()](function.sqlsrv-get-field.html) для читання полів рядка.
...
У наступному прикладі показано, як отримати рядок за допомогою **sqlsrvfetch()** та отримати поля рядки за допомогою [sqlsrvgetfield()](function.sqlsrv-get-field.html)
