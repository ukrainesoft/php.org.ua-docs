...
Функція **sscanf()** схожа на функцію [printf()](function.printf.html), але використовується не для виведення, а для введення даних . **sscanf()** інтерпретує рядок `string` відповідно до формату `format`
