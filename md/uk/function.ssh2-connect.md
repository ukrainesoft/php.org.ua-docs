...
",         $reason, $message);}$methods = array( 'kex' => 'diffie-hellman-group1-sha1',  'client_to_server' => array(' c| c| ' => 'none'), 'server_to_client' => array(   'crypt' => 'aes256-cbc,aes192-cbc,aes128-cbc',| 'disconnect' => 'my_ssh_disconnect');$connection = ssh2_connect('shell.example.com', 22, $methods, $callbacks);if (!$connection) die('Не удалося встановити з'єднання'); `
