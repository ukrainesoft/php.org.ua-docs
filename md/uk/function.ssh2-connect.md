...
Після з'єднання користувач повинен перевірити ключ сервера, використовуючи функцію [ssh2fingerprint()](function.ssh2-fingerprint.md), і після цього авторизуватись, використовуючи пароль або відкритий ключ.
