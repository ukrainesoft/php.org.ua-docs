...
` <?php$ssh2 = ssh2_connect('shell.example.com', 22);ssh2_auth_password($ssh2, 'jdoe', 'secret');$pkey = ssh2_publickey_init($ssh2);$list ==key );foreach($list as $key) {  echo "Key: {$key['name']}
