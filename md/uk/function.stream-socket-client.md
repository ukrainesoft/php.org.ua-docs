...
> **Зауваження**
> 
> За замовчуванням потік буде відкритий у режимі блокування. Ви можете переключити його в режим неблокування, використовуючи функцію [streamsetblocking()](function.stream-set-blocking.md)
...
> **Зауваження**
> 
> Щоб вказати час очікування для читання/запису даних через сокет, скористайтеся функцією [streamsettimeout()](function.stream-set-timeout.md), оскільки параметр `timeout` застосовується лише під час створення з'єднання через сокет.
...
Діючий ресурс контексту, створений за допомогою функції [streamcontextcreate()](function.stream-context-create.md)
...
> **Зауваження**
> 
> Залежно від оточення, Unix-домени або довільний час очікування з'єднання можуть бути недоступними. Список доступних транспортів може бути отриманий за допомогою функції [streamgettransports()](function.stream-get-transports.md). Дивіться список вбудованих транспортів на сторінці [Список підтримуваних транспортних протоколів](transports.md)
