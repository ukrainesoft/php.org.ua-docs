...
Ця функція створює тільки сокет. Щоб почати приймати з'єднання, використовуйте [streamsocketaccept()](function.stream-socket-accept.html)
...
Залежно від оточення, доменні сокети Unix можуть бути недоступними. Список доступних транспортів можна отримати за допомогою функції [streamgettransports()](function.stream-get-transports.html). Дивіться [Список підтримуваних транспортних протоколів](transports.html) для переліку вбудованих транспортів.
...
Приклад нижче показує, як працювати як сервер часу, який може відповідати на запити часу, як показано в прикладі функції [streamsocketclient()](function.stream-socket-client.html)
