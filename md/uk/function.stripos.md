...
` <?php$findme    = 'a';$mystring1 = 'xyz';$mystring2 = 'ABC';$pos1 = stripos($mystring1, $findme);$pos2 = stripos($mystring2, $fin / Звичайно, 'a' не входить в 'xyz'if ($pos1 ====false) {    echo "Рядок '$findme' не найдена в>ряд> '$mystring1'"; Використання == не дасть вірного// результату, так як 'a' в нульової позиції.if ($pos2 !== false) {    echo "Знайшов '$findme' >| `
