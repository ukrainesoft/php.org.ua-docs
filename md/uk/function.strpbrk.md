...
` <?php$text = 'This is a Simple text.';// Цей код видасть "is is a Simple text.", т.к. символ 'i' зустрінеться ранішеecho strpbrk($text, 'mi');//Цей код видасть'"Simple text." символи чутливі до реєструecho strpbrk($text, 'S');?> `
