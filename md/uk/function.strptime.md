...
| Версия | Описание                                                                                                                                                                                                                                                                                                                      |
|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|        | Функцію оголошено застарілою. Замість неї використовуйте [date\_parse\_from\_format()](function.date-parse-from-format.html) (для синтаксичного аналізу, що не залежить від мовного стандарту) або [IntlDateFormatter::parse()](intldateformatter.parse.html) (Для синтаксичного аналізу, що залежить від мовного стандарту). |
...
> **Зауваження**
> 
> Насправді ця функція викликає бібліотечну функцію `strptime()`. У різних ОС поведінка функції може відрізнятися. Функція [date\_parse\_from\_format()](function.date-parse-from-format.html) позбавлена ​​цього недоліку та рекомендована до використання.
