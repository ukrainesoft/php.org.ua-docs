...
` <?php$pos = strrpos($mystring, "b");if ($pos === false) { // зверніть увагу: три знака рівності    // не найдено...}?> `

**Приклад #2 Пошук зі зміщенням**

` <?php$foo = "0123456789a123456789b123456789c";var_dump(strrpos($foo, '7', -5)); // Пошук| Результат: int(17)var_dump(strrpos($foo, '7', 20)); // Починає пошук з 20 позиції в рядку. // Результат: int(27)var_dump(strrpos($foo, '7', 28)); //Результат:bool(false)?> `
