...
Додає файл, папку або символічне посилання `path` у робочу копію. Дані будуть додані до репозиторію при наступному виклику методу [svncommit()](function.svn-commit.html) для робочої копії
