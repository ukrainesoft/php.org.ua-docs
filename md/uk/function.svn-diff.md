...
Цей приклад показує як реалізувати функцію-обертку для виведення відмінностей між двома локальними файлами, яка є переносимою та позбавлена ​​помилок під час роботи з функцією [realpath()](function.realpath.html) і зворотним слішем.
