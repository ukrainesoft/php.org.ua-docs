...
значеннях, зверніться до [константів статусів](svn.constants.md#svn.constants.status).
...
можливих значеннях, зверніться до [константів статусів](svn.constants.md#svn.constants.status).
...
можливих значеннях, зверніться до [константів типів](svn.constants.md#svn.constants.type).
