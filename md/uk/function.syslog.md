...
`<?php// відкрити syslog, включити в повідомлення ID процесу, також надіслати// повідомлення, і використовувати визначений користувачем// механізм журналуванняopenlog("myScriptLog", |||| {    // що-небудь зробити}else {    // неавторизований клієнт! // надіслати повідомлення журналу про спробу    $access = date("Y/m/d H:i:s"); syslog(LOG_WARNING, "Неавторизований клієнт: $access {$_SERVER['REMOTE_ADDR']} ({$_SERVER['HTTP_USER_AGENT']})");}closelog();?> `
