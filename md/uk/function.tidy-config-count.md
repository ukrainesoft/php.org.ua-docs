...
` <?php$html = '<p>test</I>';$config = array('doctype' => 'bogus');$tidy = tidy_parse_string($html, $config);/* Виведе 1, тому як 'bogus' некоректне оголошення типу документу */echo tidy_config_count($tidy);?> `
