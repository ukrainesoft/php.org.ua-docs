...
**Пример #1**token\_get\_all()**example**
...
**Пример #2 Пример неправильного использования**token\_get\_all()\*\*\*\*
...
**Пример #3 Пример использования**token\_get\_all()\*\* з класом, який використовує зарезервовані слова\*\*
