...
**Приклад #2 Приклад использования функции**usort()\*\* з багатовимірними масивами\*\*
...
**Приклад #4 Приклад использования функции**usort()**с применением[анонімної функції](functions.anonymous.md) для сортування багатовимірного масиву**
