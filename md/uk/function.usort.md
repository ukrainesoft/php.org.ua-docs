...
**Пример #2 Пример использования функции**usort()\*\* з багатовимірними масивами\*\*
...
**Пример #4 Пример использования функции**usort()**с применением[анонімної функції](functions.anonymous.md) для сортування багатовимірного масиву**
...
**Пример #5 Пример использования**usort()\*\* з оператором spaceship (космічний корабель)\*\*
