Сортує масив за значеннями використовуючи функцію користувача для порівняння елементів
...
Сортує `array` за значеннями, використовуючи надану користувачем функцію порівняння визначення порядку.
...
> **Зауваження**
> 
> Очевидно, що для цього тривіального випадку більш підходить функція [sort()](function.sort.html)
...
**Приклад #4 Приклад використання функції **usort()** з застосуванням [анонимной функции](functions.anonymous.html) для сортування багатовимірного масиву**
