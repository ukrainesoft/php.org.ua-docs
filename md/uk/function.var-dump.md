...
Усі загальнодоступні, закриті та захищені властивості об'єкта будуть повернуті при виведенні, якщо об'єкт не реалізує метод [\_\_debugInfo()](language.oop5.magic.html#language.oop5.magic.debuginfo)
...
-   [\_\_debugInfo()](language.oop5.magic.html#language.oop5.magic.debuginfo)