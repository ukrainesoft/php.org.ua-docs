...
**varexport()** повертає структуровану інформацію про цю змінну. Функція аналогічна [vardump()](function.var-dump.html) за одним винятком: подання, що повертається, є повноцінним PHP-кодом.
