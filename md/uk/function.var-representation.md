...
**varrepresentation()** (модуль PECL varrepresentation) повертає рядок із структурованою інформацією про цю змінну. Функція схожа на [var\_export()](function.var-export.html) з відмінностями у відступах, екрануванні рядків та уявленнях масиву.
...
Бітова маска, що складається з: **`VAR_REPRESENTATION_SINGLE_LINE`** **`VAR_REPRESENTATION_UNESCAPED`**. Поведінка цих констант описана на сторінці [константы var\_representation](var-representation.constants.html)
...
**Приклад #5 Приклад використання [\_\_set\_state()](language.oop5.magic.html#object.set-state)**
