...
| `right` порожній, а `left` не порожній | Буде викинуто виняток [com\_exception](class.com-exception.html) з кодом **`DISP_E_DIVBYZERO`** |
| `left` порожній, а `right` не порожній. | Поверне 0 типу double |
| Обидва операнди порожні | Буде викинуто виняток [com\_exception](class.com-exception.html) з кодом **`DISP_E_OVERFLOW`** |
