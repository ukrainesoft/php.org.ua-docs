...
Виводить значення масиву, відформатовані відповідно до аргументу
`format`, описаному в документації функції
[sprintf()](function.sprintf.md).

Працює як [printf()](function.printf.md), але приймає не
...
` <?phpvprintf("%04d-%02d-%02d", explode('-', '1988-8-1'));?> `
