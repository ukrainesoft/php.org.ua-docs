...
Виводить значення масиву, відформатовані відповідно до аргументу `format`, описаному в документації функції [sprintf()](function.sprintf.md)

Працює як [printf()](function.printf.md)Але приймає не змінну кількість аргументів, а масив.
