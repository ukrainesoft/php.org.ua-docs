...
Виводить значення масиву, відформатовані відповідно до аргументу `format`, описаному в документації функції [sprintf()](function.sprintf.html)

Працює як [printf()](function.printf.html)Але приймає не змінну кількість аргументів, а масив.
...
**Приклад #1 **vprintf()**: доповнення нулями цілих чисел**
