...
Якщо вказано параметр `gracefulMode`, режим виходу змінюється. Коли режим виходу не є коректним, код виходу, що використовується, може бути встановлений за допомогою функції [win32setserviceexitcode()](function.win32-set-service-exit-code.md)
