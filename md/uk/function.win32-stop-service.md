...
**win32_stop_service**(string `$servicename`, string `$machine` u003d ?):
void

Зупиняє зазначену службу. Вимагає адміністративних привілеїв,
або акаунта з належним чином налаштованим ACL для сервісу.
