...
wincache_scache_meminfo — Отримує інформацію про використання
кеш-пам'яті сесії
...
Отримує інформацію про використання пам'яті кеш сесії.
...
Масив метаданих про використання кеш-пам'яті сесії або **`false`**
у разі виникнення помилки.

Масив, що повертається цією функцією, містить такі елементи:

- `memory_total` - обсяг пам'яті в байтах, виділений для кеш-пам'яті
сесії.
- `memory_free` - обсяг вільної пам'яті в байтах, доступною для
кеш-пам'яті сесії.
...
внутрішніх структур кешу сесії.

### Приклади

**Приклад #1 Приклад використання **wincache_scache_meminfo()****
