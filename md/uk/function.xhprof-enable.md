...
Необов'язкові прапори для отримання додаткової інформації для профілювання. Подробиці можна знайти у розділі [Константи XHprof](xhprof.constants.md)НаПриклад,\*\*`XHPROF_FLAGS_MEMORY`\*\*включает профилирование памяти.
...
**Приклад #1 Приклад використання** xhprof\_enable()\*\*\*\*
