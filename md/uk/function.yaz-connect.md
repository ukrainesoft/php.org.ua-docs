...
**yazconnect()** готує з'єднання із сервером Z39.50. Функція не блокує і не намагається встановити з'єднання, а лише готує з'єднання для подальшого виконання функцією [yazwait()](function.yaz-wait.md)
...
> **Зауваження**
> 
> Якщо ви відкрили постійне з'єднання, ви не зможете закрити його пізніше за допомогою [yazclose()](function.yaz-close.md)
