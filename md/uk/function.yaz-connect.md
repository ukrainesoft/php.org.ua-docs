...
yaz\_connect — Підготовка підключення до сервера Z39.50
...
**yaz\_connect()** готує з'єднання із сервером Z39.50. Функція не блокує і не намагається встановити з'єднання, а лише готує з'єднання для подальшого виконання функцією [yaz\_wait()](function.yaz-wait.md)
...
Має логічний тип. Якщо приймає **`true`** - з'єднання постійне, якщо \*\*`false`\*\*- непостоянное соединение. По умолчанию соединение постоянное.

> **Зауваження** :
> 
> Якщо ви відкрили постійне з'єднання, ви не зможете закрити його пізніше за допомогою [yaz\_close()](function.yaz-close.md)
...
Дескриптор з'єднання у разі успішного виконання або \*\*`false`\*\*в случае возникновения ошибки.
