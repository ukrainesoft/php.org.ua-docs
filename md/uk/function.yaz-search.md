...
| @attr [set] type=value query | встановлює атрибути запиту. Значення type та value - цілочислові та визначають тип атрибуту та тип значення відповідно. Значення set, якщо воно встановлено, визначає налаштування атрибутів. |
