...
Починаючи з PHP 8.0.0, [именованные аргументы](functions.arguments.html#functions.named-arguments) можна використовувати для пропуску кількох необов'язкових параметрів.
...
> **Зауваження**: Починаючи з PHP 7.1.0, опущення параметра, не заданого за умовчанням, викидає виняток [ArgumentCountError](class.argumentcounterror.html); у попередніх версіях це викликало попередження.
...
Багатокрапка (`...`) можна використовувати під час виклику функції, щоб розпакувати масив (array) або [Traversable](class.traversable.html) змінну до списку аргументів:
...
Також можна додати [объявление типа](language.types.declarations.html) перед `...`. У цьому випадку всі аргументи, оброблені трьома крапками (`...`), повинні відповідати цьому типу параметра.
...
Зрештою, можна передавати аргументи [по ссылке](functions.arguments.html#functions.arguments.by-reference). Для цього перед `...` потрібно поставити амперсанд (`&`
