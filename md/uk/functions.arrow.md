...
Стрілецькі функції підтримують ті ж можливості, що й [анонімні функції](functions.anonymous.html), за винятком того, що використання змінних із батьківської області завжди виконується автоматично.
...
> **Зауваження**: Можно використовувати [funcnumargs()](function.func-num-args.html) [funcgetarg()](function.func-get-arg.html) і [funcgetargs()](function.func-get-args.html) у стрілочній функції.