...
`<?php$makefoo = true;/* Ми не можемо викликати функцію foo() в цьому місце,   оскільки вона ще не не визначено, но ми можемо    foo() { {   echo "Я не існую до тих пор, поки виконання програми мене не досягне.
