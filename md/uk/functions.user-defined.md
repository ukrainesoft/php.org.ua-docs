...
Функції PHP підтримують як [списки аргументів змінної довжини](functions.arguments.md#functions.variable-arg-list), так і [значения аргументов по умолчанию](functions.arguments.md#functions.arguments.default). Дивіться також опис функцій [funcnumargs()](function.func-num-args.md) [funcgetarg()](function.func-get-arg.md) і [funcgetargs()](function.func-get-args.md) для детальнішої інформації.
