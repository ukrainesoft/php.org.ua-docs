...
Всередині функції можна використовувати будь-який коректний PHP-код, у тому числі інші функції та навіть оголошення [классов](language.oop5.basic.html#language.oop5.basic.class)
...
Функції PHP підтримують як [списки аргументов переменной длины](functions.arguments.html#functions.variable-arg-list), так і [значения аргументов по умолчанию](functions.arguments.html#functions.arguments.default). Дивіться також опис функцій [func\_num\_args()](function.func-num-args.html) [func\_get\_arg()](function.func-get-arg.html) і [func\_get\_args()](function.func-get-args.html) для детальнішої інформації.
