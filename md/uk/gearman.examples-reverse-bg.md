...
`<?php# створення об'єкта$gmclient= new GearmanClient();# вказівка сервера за мовчанням (localhost)$gmclient->addServer();# виконання в фоновому режимі$jo this is a test");if ($gmclient->returnCode() != GEARMAN_SUCCESS){ echo "bad return code
";  exit;}echo "done!
";?> `
