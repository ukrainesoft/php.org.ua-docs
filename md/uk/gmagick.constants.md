...
Результат має ту саму форму, що й вихідне зображення, але затемнений за допомогою композитного зображення у місцях перетину.
...
Те саме, що і COMPOSITE\_MULTIPLY, за винятком того, що вихідне зображення спочатку перетворюється на відтінки сірого.
...
Потім знімає цільове зображення для відображення вихідного зображення.
...
Віднімає темніше значення кольору від світлішого
...
Створює ефект аналогічний до Gmagick::COMPOSITE\_DIFFERENCE, але виглядає як зниження контрасту
