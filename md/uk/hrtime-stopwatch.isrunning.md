...
title: 'HRTime\\StopWatch::isRunning'
...
HRTime\\StopWatch::isRunning — Перевірити, чи виконується вимір
...
Повертає **`true`**или**`false`**, в залежності від того, чи запущено вимір у поточний момент.
