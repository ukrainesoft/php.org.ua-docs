...
Client, доступний для вільного завантаження з [» сайту підтримки](https://www.ibm.com/developerworks/downloads/im/db2express/index.md)
...
дійте відповідно до інструкцій [Установка модулів PECL](install.pecl.md) для встановлення. Використовуйте команду
