...
Так само, як COMPOSITE\_MULTIPLY, за винятком того, що джерело спочатку перетворюється на відтінки сірого.
...
Потім знімає кінцеве зображення з урахуванням вихідного зображення
...
Створення ефекту, схожого на imagick:: COMPOSITE\_DIFFERENCE, але з нижчим контрастом
...
Ця константа доступна, якщо Imagick був скомпільований з версією ImageMagick 6.3.6 або вищою.
...
Визначає максимальну ширину \* висоту зображення, яке може перебувати у піксеному кеші.
...
Ця константа доступна, якщо Imagick був скомпілюваний з версією ImageMagick 6.4.6 або вище.
...
Ця константа доступна, якщо Imagick був скомпільований з версією ImageMagick 6.5.3 або вищою.

**`imagick::ALPHACHANNEL_REMOVE`**(int)

Ця константа доступна, якщо Imagick був скомпільований з версією ImageMagick 6.7.8 або вищою.

**`imagick::ALPHACHANNEL_ASSOCIATE`**(int)

Ця константа доступна, якщо Imagick був скомпільований з версією ImageMagick 6.9.0 або вищою.
...
Ця константа доступна, якщо Imagick був скомпільований з версією ImageMagick 7.0.0 або вищою.
