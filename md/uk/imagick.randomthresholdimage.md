...
Змінює значення окремих пікселів залежно від інтенсивності кожного пікселя проти пороговим значенням. В результаті виходить висококонтрастне двоколірне зображення. Цей метод доступний, якщо Imagick був скомпільований з версією ImageMagick 6.2.9 або старшим.
