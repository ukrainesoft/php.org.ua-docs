...
**Приклад #1 Создание градиентного изображения, используя**Imagick::sigmoidalContrastImage()**, Придатну для плавного змішування двох зображень разом, зі змішуванням, що визначається контрастом та середньою точкою.**
