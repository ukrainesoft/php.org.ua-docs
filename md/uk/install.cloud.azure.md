...
також портована, дивіться [Windows Troubleshooting Page](install.windows.troubleshooting.md) Тим не менш, інтерфейс
...
Kudu [»https://[ім'я вашого сайту].scm.azurewebsites.net/](https://your_web_site_name.scm.azurewebsites.net/).
...
Дивись [» Azure SDK для PHP](https://github.com/Azure/azure-sdk-for-php).

Для більш докладної інформації дивись [» Azure PHP Developer Center](https://azure.microsoft.com/en-us/develop/php/)
