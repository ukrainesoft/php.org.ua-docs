...
PHP. Ви можете використовувати PHP для цілей, описаних у розділі [Що може PHP?](intro-whatcando.md)
...
CLI. Докладніше про це можна прочитати в розділі [Використання PHP в командному рядку](features.commandline.md). В цьому випадку вам не
...
інформації про PHP-GTK [» відвідайте сайт, присвячений цьому модулю](http://gtk.php.net/). PHP-GTK не включений у стандартне постачання
PHP.
