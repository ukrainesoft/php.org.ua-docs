...
також мають на увазі знайомство з [» командою pear](https://pear.php.net/manual/en/guide.users.commandline.cli.php).
...
та їх версіях можна переглянути в розділі "[»|Інструкції щодо здійснення анонімного доступу до Git](https://www.php.net/git.php)".
