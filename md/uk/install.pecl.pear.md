...
Ця команда завантажить вихідний код для модуля *extname*, скомпілює та встановить extname.so у вашу директорію [extension\_dir](ini.core.html#ini.extension-dir). Файл extname.so може бути завантажений у php.ini
