...
За інструкціями з компіляції модуля в PHP зверніться до розділу "[Складання з вихідників](install.windows.building.md)".
...
Будь ласка, прочитайте [» публікація PECL](https://pecl.php.net/package-new.php); перед відправкою вашого
модуля в PECL.
