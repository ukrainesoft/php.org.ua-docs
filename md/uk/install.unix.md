...
- [Установка з інтерфейсами CGI та командної рядки](install.unix.commandline.md)
...
Як сказано в розділі [Загальні вказівки по установці](install.general.md), в цьому розділі ми в основному описуємо
...
основних параметрів можна переглянути в [Основні параметри конфігурації](configure.about.md), тоді як параметри, специфічні
...
вийшло і ви не можете зрозуміти чому дивіться розділ [Проблеми установки](install.problems.md).
...
> збирати PHP [без підтримки JIT компіляції > PCRE](pcre.installation.md) або бінарні файли повинні бути внесені
