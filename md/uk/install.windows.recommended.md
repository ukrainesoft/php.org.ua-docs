---
navigation:
  - install.windows.tools.md: « Інструмент встановлення PHP на Windows
...
Более подробно читайте:[Конфігурація WinCache](wincache.configuration.md)
...
PHP модулі включають mysqli та pdo\_mysql.

Дополнительно читайте[» https://dev.mysql.com/downloads/windows/](https://dev.mysql.com/downloads/windows/)
