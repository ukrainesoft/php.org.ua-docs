...
Перетворює символ на його еквівалент у верхньому регістрі. Якщо немає, то повертається вихідний символ.
...
Повертає SimpleUppercaseMapping символ, якщо він є. В іншому випадку повертається вихідний символ.
