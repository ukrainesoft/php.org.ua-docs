...
Для обчислень з довільною точністю PHP надає BCMath, який підтримує числа будь-якого розміру та точності, аж до `2147483647` (або `0x7FFFFFFF`) десяткових знаків, якщо вистачить пам'яті, поданих у вигляді рядків.
