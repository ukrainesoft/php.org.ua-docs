...
> **Зауваження**
> 
> Починаючи з dbase 7.0.0, підтримуються обнулювані поля для баз даних **`DBASE_TYPE_FOXPRO`**. Якщо поле обнулюване. При передачі **`null`** буде встановлений відповідний прапор і, при подальшому видаленні поля, буде повернено значення **`null`**
