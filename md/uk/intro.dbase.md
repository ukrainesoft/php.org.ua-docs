...
База даних dBase є простою послідовністю файлів з фіксованою довжиною запису. Записи додаються до кінця файлу і видалені записи будуть (фізично) зберігаються до дзвінка [dbasepack()](function.dbase-pack.md)
