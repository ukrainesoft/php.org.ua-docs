...
Модуль інтернаціоналізації (далі Intl) - це обгортка для бібліотеки [» ICU](https://icu.unicode.org/), що дозволяє програмістам на PHP проводити різні операції, які залежать від локалі, наприклад, форматування, транслітерація, перетворення кодувань, операції з календарем, сумісне з [» UCA](https://www.unicode.org/reports/tr10/) порівняння, визначення меж тексту та працювати з ідентифікаторами локалів, часовими поясами та графемами.
...
-   Модуль часового поясу: надає обгортку над[» базою даних часових поясів](https://www.iana.org/time-zones), в якій міститься вичерпна інформація про всі світові часові пояси.
...
-   [» Різна документація ICU](https://icu.unicode.org/docs/)
    
-   [» Посібник користувача ICU](https://unicode-org.github.io/icu/userguide/)
    
-   [» Алгоритм зіставлення Unicode](https://www.unicode.org/reports/tr10/)
