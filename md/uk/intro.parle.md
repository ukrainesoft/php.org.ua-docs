...
Звичайний варіант використання parle – це коли формат даних надто складний для обробки регулярним виразом, що збігається з PCRE. У цьому широке практичне застосування. Будь то конкретний формат даних, модифікація поведінки існуючих функцій, навіть власну мову програмування тощо. Корисні допоміжні методи, такі як [Parle\\Lexer::dump()](parle-lexer.dump.html) для перевірки згенерованого стану або [Parle\\Parser::dump()](parle-parser.dump.html) для перевірки згенерованої граматики. Метод [Parle\\Parser::trace()](parle-parser.trace.html) також можна використовувати для відстеження операції синтаксичного аналізу.