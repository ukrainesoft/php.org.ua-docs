...
> **Зауваження** :
> 
> Подробное описание библиотеки libradius можно найти[»тут](http://www.freebsd.org/cgi/man.cgi?query=libradius). Детальна інформація про файл конфігурації лежить [»тут](http://www.freebsd.org/cgi/man.cgi?query=radius.conf)
