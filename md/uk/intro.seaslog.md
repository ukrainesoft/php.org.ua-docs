...
Функція syslog error\_log, вбудована в PHP, є потужною та високопродуктивною, але через різні дефекти (у error\_log немає рівня помилок, немає фіксованого формату, syslog незалежно від модуля і змішується із системним журналом), що знижує гнучкість і не може відповідати вимогам програми.
...
Подробнее в[» документації SeasLog](https://seasx.github.io/SeasLog/)на GitHub.
