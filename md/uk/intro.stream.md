...
обгорток, як вбудованих в PHP спочатку (дивіться [Підтримувані протоколи та обгортки](wrappers.md)), так і додаткових.
...
оберток можна подивитися тут [Підтримувані протоколи та обертки](wrappers.md). Якщо назва обгортки не вказана, кожна
