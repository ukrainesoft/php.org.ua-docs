...
XML документи. Він підтримує три [кодування символів](xml.encoding.md) вихідного тексту також підтримуваних PHP:
`US-ASCII`, `ISO-8859-1` та `UTF-8`. `UTF-16` не підтримується.

Модуль дозволить вам [створювати XML-аналізатори](function.xml-parser-create.md) і надалі визначити
