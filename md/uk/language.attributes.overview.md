...
метадані можна отримати під час виконання, використовуючи [Reflection API](book.reflection.md). Таким чином, атрибути можна розглядати
