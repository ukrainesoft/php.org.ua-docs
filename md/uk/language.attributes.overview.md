...
Атрибути пропонують можливість додавати структуровані, машиночитані метадані для наступних декларацій у коді: класи, методи, функції, параметри, властивості та константи класу. Прив'язані метадані можна отримати під час виконання, використовуючи [Reflection API](book.reflection.html). Таким чином, атрибути можна розглядати як мову конфігурації, вбудовану безпосередньо в код.
