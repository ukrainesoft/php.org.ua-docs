...
При виведенні великих блоків тексту вихід з режиму синтаксичного аналізу PHP зазвичай ефективніший, ніж надсилання тексту за допомогою функцій [echo](function.echo.html) або [print](function.print.html)
