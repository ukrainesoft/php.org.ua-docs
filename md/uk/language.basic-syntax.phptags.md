...
PHP включає короткий echo-тег `<?=`, який є
скороченням для більш багатослівного `<?php echo`.

**Приклад #1 Відкриваючі та закриваючі теги PHP**

1.  <?php echo 'якщо ви хотите зберігати код PHP в документах XHTML або XML,                  то | ?>2. Ви можете використовувати короткий 'echo'-тег щоб <?= 'надрукувати цю рядок' ?>. Цей тег еквівалентний такому коду    <?php echo 'надрукувати цю рядок' ?>.3. <? echo 'цей код з короткими тегами, але он працювати тільки якщо '. 'включена опція "short_open_tag"'; ?>`
...
> звичайні теги (`<?php ?>` і `<?= ?>`) для максимальної
> сумісності.
