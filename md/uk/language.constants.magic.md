---
navigation:
  - language.constants.predefined.md: « Зумовлені константи
...
| **`__CLASS__`** | Назва класу. Це ім'я містить назву простору імен, у якому клас був оголошений (наприклад, `Foo\Bar`). При використанні у методах трейтів \_\_CLASS\_\_ є ім'ям класу, у якому ці методи використовують. |
...
-   [get\_object\_vars()](function.get-object-vars.md)
