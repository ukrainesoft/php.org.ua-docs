...
Отримати значення константи можна, вказавши її ім'я. На відміну від змінних, вам *не потрібно* попереджувати ім'я константи символом `$`. Також можна використовувати функцію [constant()](function.constant.md) для отримання константи, якщо ви формуєте ім'я константи динамічно. Використовуйте функцію [getdefinedconstants()](function.get-defined-constants.md) для отримання списку всіх констант.
