...
-   [Магические методы](language.oop5.magic.html), крім наведених нижче, заборонені.
...
-   До перерахувань та варіантів можуть бути додані [атрибуты](language.attributes.html). Цільовий фільтр **`TARGET_CLASS`** включає самі перерахування. Цільовий фільтр **`TARGET_CLASS_CONST`** включає варіанти перерахувань.
-   Магічні методи [\_\_call](language.oop5.overloading.html#object.call) [\_\_callStatic](language.oop5.overloading.html#object.callstatic), і [\_\_invoke](language.oop5.magic.html#object.invoke)
...
Крім того, варіанти перерахування не можуть бути створені безпосередньо за допомогою `new` або за допомогою [ReflectionClass::newInstanceWithoutConstructor()](reflectionclass.newinstancewithoutconstructor.html). Обидва способи призведуть до помилки.
