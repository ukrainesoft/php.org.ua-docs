...
Найпопулярніший приклад перерахування - вбудований логічний тип, він перераховуємо і припускає значення **`true`**и**`false`**. Перерахування дозволяють розробникам визначати свої довільно надійні перерахування.
