...
Якщо клас, успадкований від Exception перевизначає [конструктор](language.oop5.decon.html)необхідно викликати в конструкторі [parent::\_\_construct()](language.oop5.paamayim-nekudotayim.html)щоб бути впевненим, що всі доступні дані були правильно присвоєні. Метод [\_\_toString()](language.oop5.magic.html) може бути перевизначений, щоб забезпечити потрібний висновок, коли об'єкт перетворюється на рядок.

> **Зауваження**
> 
> Винятки не можна клонувати. Спроба [клонировать](language.oop5.cloning.html) виняток призведе до непоправної помилки **`E_ERROR`**
