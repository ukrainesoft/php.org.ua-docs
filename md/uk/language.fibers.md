...
Файбери можуть бути призупинені під час виклику будь-якої функції, включаючи ті, що викликаються з віртуальної машини PHP, наприклад, функції, що надаються [arraymap()](function.array-map.html), або методи, викликані foreach для об'єкта [Iterator](class.iterator.md)
