...
Генератори можуть надавати значення за посиланням. Це робиться так само, як [повернення посилань із функцій](functions.returning-values.html)": додавання амперсанди (&) перед ім'ям функції.
