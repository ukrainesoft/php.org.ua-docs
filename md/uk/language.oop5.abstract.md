...
При успадкування від абстрактного класу, всі методи, помічені абстрактними у батьківському класі, повинні бути визначені в дочірньому класі та дотримуватися звичайних правил [наследования](language.oop5.inheritance.html) і [совместимости сигнатуры](language.oop5.basic.html#language.oop.lsp)
