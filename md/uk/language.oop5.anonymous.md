...
`<?phpclass Outer{    private $prop = 1; protected $prop2 = 2; protected function func1()    {       return 3; }    public function func2()    {        return new class($this->prop) extends Outer {           | public function __construct($prop)             {                $this->prop3 = $prop; }                  ¦¦¦¦¦¦¦¦¦            ¦¦¦¦ }         }; }}echo (new Outer)->func2()->func3(); `
...
`<?phpfunction anonymous_class(){    return new class {};}if (get_class(anonymous_class()) === get_class(anonymous_class()) { з| з| з| } `
