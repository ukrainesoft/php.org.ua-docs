...
navigation:
  ...
  - language.oop5.object-comparison.html: Порівняння об'єктів »
  - index.md: PHP Manual
...
Копія об'єкта створюється за допомогою ключового слова `clone` (який викликає метод [clone()](language.oop5.cloning.html#object.clone) об'єкта, якщо це можливо).
...
Після завершення клонування, якщо метод [clone()](language.oop5.cloning.html#object.clone) визначено, то буде викликаний метод [clone()](language.oop5.cloning.html#object.clone) новоствореного об'єкта для можливої ​​зміни всіх необхідних властивостей.
