...
Копія об'єкта створюється за допомогою ключового слова `clone` (який викликає метод [\_\_clone()](language.oop5.cloning.html#object.clone) об'єкта, якщо це можливо).
...
Після завершення клонування, якщо метод [\_\_clone()](language.oop5.cloning.html#object.clone) визначено, то буде викликаний метод [\_\_clone()](language.oop5.cloning.html#object.clone) новоствореного об'єкта для можливої ​​зміни всіх необхідних властивостей.
