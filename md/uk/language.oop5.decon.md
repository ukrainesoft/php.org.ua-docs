...
На відміну від інших методів, [construct()](language.oop5.decon.md#object.construct) звільняється від звичайних [правил сумісності сигнатури](language.oop5.basic.md#language.oop.lsp) при наслідуванні.
...
У новому коді завжди використовуйте [construct()](language.oop5.decon.md#object.construct)
