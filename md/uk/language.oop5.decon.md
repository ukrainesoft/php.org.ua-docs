...
звільняється від звичайних [правил сумісності сигнатури](language.oop5.basic.md#language.oop.lsp) при успадкування.
...
> [callable](language.types.callable.md). Будь-які інші [декларації > типи](language.types.declarations.md) допустимі.
