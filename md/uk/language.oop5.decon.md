...
На відміну від інших методів, [\_\_construct()](language.oop5.decon.html#object.construct) звільняється від звичайних [правил совместимости сигнатуры](language.oop5.basic.html#language.oop.lsp) при наслідуванні.
...
У новому коді завжди використовуйте [\_\_construct()](language.oop5.decon.html#object.construct)
...
> **Зауваження**
> 
> Властивості об'єктів не можуть бути типу [callable](language.types.callable.html) у зв'язку з неоднозначністю, яку вони представляють для двигуна PHP. Відповідно і властивості, що визначаються в конструкторі, також не можуть бути типу [callable](language.types.callable.html). Будь-які інші [декларации типов](language.types.declarations.html) допустимі.

> **Зауваження**
> 
> [Атрибуты](language.attributes.html), Задані для таких аргументів, будуть застосовані як для них самих, так і для відповідних властивостей.

#### New в ініціалізації класу

Починаючи з PHP 8.1.0, об'єкти можна використовувати як значення параметрів за промовчанням, статичних змінних і глобальних констант, а також в аргументах атрибутів. Об'єкти також тепер можна передавати в [define()](function.define.html)
...
Деструктор буде викликатись навіть у тому випадку, якщо скрипт був зупинений за допомогою функції [exit()](function.exit.html). Виклик [exit()](function.exit.html) у деструкторі запобігає запуску всіх наступних функцій завершення.
