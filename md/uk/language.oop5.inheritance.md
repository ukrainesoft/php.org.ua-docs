...
[Видимість](language.oop5.visibility.html) методів, властивостей та констант можна послабити, наприклад, `защищённый` метод може бути позначений як `общедоступный`, але не можна обмежити видимість, наприклад, не можна помітити `общедоступное` властивість як `закрытое`
