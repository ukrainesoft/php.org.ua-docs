...
Інтерфейси можуть визначати [магічні методи](language.oop5.magic.html), Вимагаючи від реалізуючих класів реалізації цих методів.

> **Зауваження**
> 
> Хоча вони підтримуються, використання [конструкторів](language.oop5.decon.html#language.oop5.decon.constructor) в інтерфейсах не рекомендується. Це значно знижує гнучкість об'єкта, що реалізує інтерфейс. Крім того, до конструкторів не застосовуються правила успадкування, що може призвести до суперечливої ​​та несподіваної поведінки.
...
> **Зауваження**
> 
> Клас, що реалізує інтерфейс, повинен оголосити всі методи в інтерфейсі з [сумісною сигнатурою](language.oop5.basic.html#language.oop.lsp)

### Константи (`Constants`

Інтерфейси можуть містити константи. Константи інтерфейсів працюють так само, як і [константи класів](language.oop5.constants.html). До PHP 8.1.0 вони не могли бути перевизначені класом чи інтерфейсом, що їх успадковує.
