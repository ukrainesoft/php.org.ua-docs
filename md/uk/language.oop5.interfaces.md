...
Інтерфейси можуть визначати [магічні методи](language.oop5.magic.md), вимагаючи від реалізуючих класів
...
підтримуються [іменовані аргументи](functions.arguments.md#functions.named-arguments), та
...
[instanceof](language.operators.type.md) та [оголошення типів](language.types.declarations.md).
