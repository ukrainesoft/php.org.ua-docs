...
Якщо точніше говорити, пізніше статичне зв'язування зберігає ім'я класу вказаного в останньому "неперенаправленому виклику". У разі статичних викликів це явно вказаний клас (зазвичай ліворуч від оператора [](language.oop5.paamayim-nekudotayim.md)); у разі нестатичних викликів це клас об'єкта. "Переспрямований виклик" - це статичний виклик, що починається з `self::` `parent::` `static::`, або, якщо рухатися вгору по ієрархії класів, [forwardstaticcall()](function.forward-static-call.md). Функція [getcalledclass()](function.get-called-class.md) може бути використана для отримання рядка з ім'ям викликаного класу, а `static::` представляє її сферу дії.
