...
Оператор дозволу області видимості (також званий "Paamayim Nekudotayim") або просто "подвійна двокрапка" - це лексема, що дозволяє звертатися до [статичним](language.oop5.static.html) властивостям, [константам](language.oop5.constants.html) та перевизначеним властивостям або методам класу.
