...
> **Зауваження**
> 
> Модифікатор readonly може застосовуватися тільки до [типізованим властивостям](language.oop5.properties.md#language.oop5.properties.typed-properties). Readonly-властивість без обмежень типу можна створити за допомогою типу [mixed](language.types.declarations.md#language.types.declarations.mixed)
