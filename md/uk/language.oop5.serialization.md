...
Зверніть увагу, що, крім вищенаведеної поради, також можна підключитися до подій серіалізації та десеріалізації об'єкта за допомогою методів [\_\_sleep()](language.oop5.magic.html#object.sleep) і [\_\_wakeup()](language.oop5.magic.html#object.wakeup). Метод [\_\_sleep()](language.oop5.magic.html#object.sleep) також дозволяє серіалізувати лише деяке підмножина властивостей об'єкта.