...
| object | object | Вбудовані класи можуть визначати власні правила порівняння, об'єкти різних класів не порівнюються, про порівняння об'єктів одного класу дивіться [Сравнение объекта](language.oop5.object-comparison.html) |
