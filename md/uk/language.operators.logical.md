...
Сенс двох різних варіантів для операторів "and" та "or" у тому, що вони працюють з різними пріоритетами (див. таблицю [Приоритет выполнения операторов](language.operators.precedence.html)
