...
-   [Строкові оператори »](language.operators.string.html)
...
Сенс двох різних варіантів для операторів "and" та "or" у тому, що вони працюють з різними пріоритетами (див. таблицю [Пріоритет виконання операторів](language.operators.precedence.html)
