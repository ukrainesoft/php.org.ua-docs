...
**Приклад #1 Приклад использования оператора`instanceof` з класами**
...
**Приклад #2 Использование оператора`instanceof` з успадкованими класами**
...
**Приклад #3 Использование оператора`instanceof` для перевірки того, що об'єкт - це *не* екземпляр класу**
...
**Приклад #4 Использование оператора`instanceof` з інтерфейсами**
...
**Приклад #5 Использование оператора`instanceof` з іншими змінними**
...
**Приклад #6 Приклад использования оператора`instanceof` для перевірки інших змінних**
...
**Приклад #7 Использование`instanceof` для перевірки констант**
...
**Приклад #8 Приклад использования`instanceof` з довільним виразом**
