...
Зазвичай, деякий [оператор](language.operators.md) повертає значення типу bool, яке потім передається [управляющей конструкции](language.control-structures.md)
