...
` <?php$foo = 1 + "10.5"; // $foo вважається за число з плаваючою точкою (11.5)$foo = 1 + "-1.3e3"; // $foo вважається за число з плаваючою точкою (-1299)$foo = 1 + "bob-1.3e3"; //TypeError починаючи с PHP 8.0.0. У більш ранніх версіях $foo вважалося за ціле число (1)$foo = 1 + "bob3"; // TypeError починаючи з PHP 8.0.0, У більш ранніх версіях $foo вважалося за ціле число (1)$foo = 1 + "10 Small Pigs"; //$foo - ціле (11). У PHP 8.0.0 створюється помилка рівня E_WARNING, а в більш ранніх версіях рівня E_NOTICE$foo = 4 + "10.2 Little Piggies"; //$foo - число з плаваючою точкою (14.2). У PHP 8.0.0 створюється помилка рівня E_WARNING, а у більш ранніх версіях рівня E_NOTICE$foo = "10.0 pigs " + 1; // $foo - число з плаваючою точкою(11). В PHP 8.0.0 створюється помилка рівня E_WARNING, а у більш ранніх версіях рівня E_NOTICE$foo = "10.0 pigs " + 1.0; // $foo - число з плаваючою точкою(11). У PHP 8.0.0 створюється помилка рівня E_WARNING, а в більш ранніх версіях рівня E_NOTICE?> `
