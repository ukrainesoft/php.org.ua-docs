...
Як ви могли бачити вище, пряме перетворення в рядок масивів, об'єктів або ресурсів не дає жодної корисної інформації про значення, крім їх типів. Найкращий спосіб виведення значень для налагодження - використовувати функції [printr()](function.print-r.html) і [vardump()](function.var-dump.md)
