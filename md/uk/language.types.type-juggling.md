...
`<?php$foo = 10; // $foo - це ціле число$bar = (bool) $foo; // $bar - це логічне значення?> `
...
>
> `<?php$foo = 10; // $foo є цілом числом$str = "$foo"; // $str є рядком$fst = (string) $foo; // $fst також є рядком// Виводить, "вони однакові"if ($fst === $str) {    echo "вони однакові";}?> `
...
> версій PHP:
>
> ` <?php$a    = 'car'; // $a є рядком$a[0] = 'b'; // $a  як і раніше є рядкомecho $a; // Bar?> `
>
