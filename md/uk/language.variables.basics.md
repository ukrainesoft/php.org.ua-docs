...
> **Зауваження** `$this` - це спеціальна змінна, якій не можна нічого надавати. До PHP 7.1.0 було можливе опосередковане присвоєння (наприклад, з використанням [переменных переменных](language.variables.variable.html)

**Підказка**

Дивіться також [Руководство по именованию](userlandnaming.html)

Для отримання інформації про функції роботи зі змінними звертайтесь до розділу [функций работы с переменными](ref.var.html)
...
PHP також пропонує інший спосіб присвоєння значень змінним: [присвоение по ссылке](language.references.html). Це означає, що нова змінна просто посилається (інакше кажучи, стає псевдонімом або вказує) на оригінальну змінну. Зміни у новій змінній відбиваються на оригіналі, і навпаки.
