...
> **Зауваження** `$this` - це спеціальна змінна, якій не можна нічого надавати. До PHP 7.1.0 було можливе опосередковане присвоєння (наприклад, з використанням [змінних змінних](language.variables.variable.md)
