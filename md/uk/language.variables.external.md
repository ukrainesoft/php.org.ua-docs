...
PHP прозоро підтримує HTTP cookies як визначено в [» RFC 6265](http://www.faqs.org/rfcs/rfc6265). Cookies - це механізм для
...
вміст, який приходить у [суперглобальні масиви](language.variables.superglobals.md), наприклад, `$_POST` та
