...
Фігурні дужки можуть використовуватися, щоб чітко розмежувати ім'я властивості. Вони найбільш корисні при отриманні доступу до значень всередині властивості, що містить масив, коли ім'я властивості складається з декількох частин, або коли ім'я властивості містить символи, які не дійсні (наприклад, з функції [json\_decode()](function.json-decode.html) або з [SimpleXML](book.simplexml.html)
...
Зверніть увагу, що змінні змінних не можуть використовуватися з [суперглобальными массивами](language.variables.superglobals.html) PHP. Змінна `$this` також є особливою, нею не можна посилатися динамічно.