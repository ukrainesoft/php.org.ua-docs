...
Фігурні дужки можуть використовуватися, щоб чітко розмежувати ім'я властивості. Вони найбільш корисні при отриманні доступу до значень всередині властивості, що містить масив, коли ім'я властивості складається з декількох частин, або коли ім'я властивості містить символи, які не дійсні (наприклад, з функції [jsondecode()](function.json-decode.html) або з [SimpleXML](book.simplexml.html)
