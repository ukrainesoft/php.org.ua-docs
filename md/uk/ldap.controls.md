...
Якщо керуючі об'єкти передані у функцію [ldapparseresult()](function.ldap-parse-result.html), значення будуть перетворені на масив, якщо підтримуються. Підтримується таке:
