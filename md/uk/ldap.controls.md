...
Якщо керуючі об'єкти передані у функцію [ldap\_parse\_result()](function.ldap-parse-result.html), значення будуть перетворені на масив, якщо підтримуються. Підтримується таке:
