...
використовувати опцію **--with-ldap[=DIR]** при компіляції PHP, де DIR -
Це каталог установки бази LDAP. Щоб увімкнути підтримку SASL, переконайтесь
що використана опція **--with-ldap-sasl[=DIR]**, і що `sasl.h`
існує у системі.
...
встановлені належні [параметри навколишнього середовища Oracle](oci8.requirements.md).
