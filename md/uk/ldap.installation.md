---
navigation:
  - ldap.requirements.md: « Вимоги
  - ldap.configuration.md: Налаштування під час виконання »
  - index.md: PHP Manual
...
Для того, щоб використовувати бібліотеки Oracle LDAP, повинні бути встановлені належні [параметри навколишнього середовища Oracle](oci8.requirements.md)
