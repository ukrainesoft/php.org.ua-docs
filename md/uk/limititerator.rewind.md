...
LimitIterator::rewind — Переміщує курсор на початкову позицію
...
Переміщує ітератор на початкову позицію, задану під час створення об'єкта конструктором [LimitIterator::\_\_construct()](limititerator.construct.html)
