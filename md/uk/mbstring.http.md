...
-   Введення HTTP
    ...
    **Приклад #1 Відключення перетворення кодування введення HTTP в php.ini**
    ...
    Якщо PHP використовується як модуль Apache, можна перевизначити ці налаштування в кожній директиві віртуального хоста httpd.conf або для кожної директорії з .htaccess. За додатковою інформацією звертайтесь до розділу [Конфигурация](configuration.md) та до посібника з роботи з Apache.
