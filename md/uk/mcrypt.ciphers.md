...
Тут перераховані шифри, що підтримуються модулем mcrypt. Для повного списку шифрів, що підтримуються, дивіться список в кінці файлу mcrypt.h. Головне правило API mcrypt-2.2.x API полягає в тому, що доступ до шифрів з PHP здійснюється шляхом використання констант MCRYPTім'яшифру. Ці константи також працюють з AI libmcrypt-2.4.x та libmcrypt-2.5.x, але також можна задати шифр на ім'я за допомогою функції [mcryptmoduleopen()](function.mcrypt-module-open.md)
