...
> **Зауваження** :
> 
> Метод призначений для налагодження та не повинен використовуватися у великих масштабах!
...
Повертає список ключів, що зберігаються на всіх серверах у разі успішного виконання або \*\*`false`\*\*в случае возникновения ошибки.
