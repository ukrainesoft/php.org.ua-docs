...
Необхідно скомпілювати PHP з опцією **--with-mhash[=DIR]**. Можна, можливо
примусово вказати директорію з mhash.

Починаючи з PHP 5.3.0, модуль mhash емулюється через модуль [Hash](ref.hash.md). Тому вказівка директорії установки mhash не
