...
Більшість змін у PHP 5.6.x ніяк не позначаться на існуючому коді. Є [кілька несумісностей](migration56.incompatible.md) і [нових особливостей](migration56.new-features.md), які мають бути враховані. Також необхідно протестувати код перед проведенням міграції у робочих оточеннях.
