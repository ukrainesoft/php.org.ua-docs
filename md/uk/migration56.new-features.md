...
[Функції зі змінною кількістю аргументів](functions.arguments.md#functions.variable-arg-list) тепер
...
реалізований як модуль SAPI. Подробиці дивіться в [документації phpdbg](book.phpdbg.md).
...
Включно з [дозвіл перевірки бенкетів по замовчуванням](migration56.incompatible.md#migration56.incompatible.peer-verification),
підтримка звірки відбитків сертифікатів, зниження впливу атаки
переєднання TLS і безлічі нових [опцій контексту SSL](context.ssl.md) для більш точного контролю за параметрами
