...
(дивіться [оголошення повертається типу](language.types.declarations.md)), вбудовані функції PHP та
...
У PHP 7 додано підтримку [оголошення повертається типу](language.types.declarations.md). Аналогічно як і [оголошення типів аргументів](language.types.declarations.md), оголошення типу
...
опцій, які перевизначать [конфігураційні директиви сесії](session.configuration.md) встановлені у php.ini.
