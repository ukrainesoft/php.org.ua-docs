...
Единственное ограничение, что слово`class` все ще не можна використовувати як ім'я константи, так як воно буде перетинатися із синтаксисом дозволу імені класу (`ClassName::class`
