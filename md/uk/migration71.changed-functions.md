...
-   [sessionstart()](function.session-start.html) тепер повертає **`false`** і більше не ініціалізує [SESSION](reserved.variables.session.html)коли вона не змогла запустити сесію.