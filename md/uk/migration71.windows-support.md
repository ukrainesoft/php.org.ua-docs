...
Особливе зауваження для систем DBCS – перемикання кодування під час виконання за допомогою [iniset()](function.ini-set.html) може викликати проблеми з відображенням. Різниця із системами без DBCS полягає в тому, що розширені символи вимагають двох осередків консолі для відображення. У деяких випадках може відбутися лише відображення символів у гліфи поточного шрифту без його зміни. Це у характері систем DBCS. Найпростіший спосіб уникнути проблем із відображенням - відмовитися від використання [iniset()](function.ini-set.md) для зміни кодової сторінки.
