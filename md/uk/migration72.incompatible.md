...
`<?php// приведення масиву к об'єкту$arr = [0 => 1];$obj = (object)$arr;var_dump(   $obj,    $obj->{'0'},   ->{0} // тепер працює); `

Результат виконання цього прикладу:

object(stdClass)#1 (1) {
["0"]=> // тепер це рядковий ключ, а не числовий
int(1)
}
int(1)
int(1)
...
` <?php// приведення об'єкту в масив$obj = new class {    public function __construct()    {        $this->{0} =| } }; `

Результат виконання цього прикладу:

array(1) {
[0]=> // тепер це числовий ключ, а не рядковий
int(1)
}
int(1)
int(1)
