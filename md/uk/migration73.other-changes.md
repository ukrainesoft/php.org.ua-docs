...
Наступні ini-директиви додані для налаштування логування, якщо для опції [error_log](errorfunc.configuration.md#ini.error-log)
...
Додано параметр контексту zlib/level для [обгортки compress.zlib](wrappers.compression.md), щоб полегшити встановлення
