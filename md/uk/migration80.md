...
Нова версія містить ряд [новых функций](migration80.new-features.html) і [несовместимостей](migration80.incompatible.html), наявність яких слід перевірити перед перемиканням версій PHP у виробничому середовищі.
