...
Драйвер LMDB тепер приймає прапори **`DBA_LMDB_USE_SUB_DIR`**или**`DBA_LMDB_NO_SUB_DIR`**, щоб визначити, чи має він створювати підкаталог чи ні під час створення файлу бази даних.
