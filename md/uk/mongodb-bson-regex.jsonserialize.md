...
MongoDB\BSON\Regex::jsonSerialize — Повертає уявлення, яке
можна перетворити на JSON

### Опис

final public **MongoDB\BSON\Regex::jsonSerialize**():
...
JSON-представлення [MongoDB\BSON\Regex](class.mongodb-bson-regex.md).
