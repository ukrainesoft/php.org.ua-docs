...
navigation:
  ...
  - mongodb-bson-undefined.serialize.md: 'MongoDB\\BSON\\Undefined::serialize »'
  - index.md: PHP Manual
  - class.mongodb-bson-undefined.md: MongoDB\\BSON\\Undefined
title: 'MongoDB\\BSON\\Undefined::jsonSerialize'
...
MongoDB\\BSON\\Undefined::jsonSerialize — Повертає уявлення, яке можна перетворити на JSON
...
Повертає дані, які можуть бути серіалізовані за допомогою [json\_encode()](function.json-encode.md)для создания расширенного JSON-представления[MongoDB\\BSON\\Undefined](class.mongodb-bson-undefined.md)
