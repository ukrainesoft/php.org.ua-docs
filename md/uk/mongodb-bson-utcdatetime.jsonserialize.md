...
Повертає дані, які можуть бути серіалізовані за допомогою [jsonencode()](function.json-encode.md) для створення розширеного JSON-подання [MongoDBBSONUTCDateTime](class.mongodb-bson-utcdatetime.md)
