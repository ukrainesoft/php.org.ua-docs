...
navigation:
  ...
  - mongodb-driver-manager.executebulkwrite.md: 'MongoDBDriverManager::executeBulkWrite »'
  - index.md: PHP Manual
...
Створює новий об'єкт [MongoDBDriverClientEncryption](class.mongodb-driver-clientencryption.md) із заданими параметрами.
...
Повертає новий екземпляр [MongoDBDriverClientEncryption](class.mongodb-driver-clientencryption.md)
