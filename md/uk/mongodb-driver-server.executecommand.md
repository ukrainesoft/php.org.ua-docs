...
-   Викидає виняток [MongoDB\\Driver\\Exception\\RuntimeException](class.mongodb-driver-exception-runtimeexception.html) у разі інших помилок (наприклад, неправильна команда, видача команди записи на вторинний пристрій).
