...
Від цієї атаки досить легко захиститись: переконайтеся, що параметри $GET та $POST відповідають очікуваному типу, перш ніж надсилати в базу даних. PHP має функцію [filtervar()](function.filter-var.md), щоб допомогти з цим.
