...
-   Примітки для Windows: Щоб підготувати оточення, перегляньте офіційну документацію зі збирання Windows для [» текущего SDK](https://wiki.php.net/internals/windows/stepbystepbuild_sdk_2)
