...
Стандартний пароль, який використовується для з'єднання з сервером бази даних, якщо не вказано інший. Не працює в [SQL safe mode](ini.core.md#ini.sql.safe-mode)
