...
Примечание:`[DIR]` є шляхом до файлів клієнтської бібліотеки MySQL (*заголовкам та бібліотекам*), які можна завантажити з [» MySQL](http://www.mysql.com/)
...
> **Зауваження** :
> 
> Если при старте веб-сервера происходит подобная ошибка:`"Unable to load dynamic library './php_mysql.dll'"`, ("Неможливо підвантажити динамічну бібліотеку './php\_mysql.dll'"), то це трапляється через те, що на вашій системі не може бути знайдена php\_mysql.dll та/або libmysql.dll.

## PHP 5.3.0+

[MySQL Native Driver](mysqlnd.overview.md) увімкнено за замовчуванням. В тому числі php\_mysql.dll, але без вимоги та використання libmysql.dll.
