...
За додатковою інформацією про модуль `mysqli`, звертайтесь до розділу [MySQLi](book.mysqli.md)
...
Додаткову інформацію про PDO дивіться у розділі [PDO](book.pdo.md)
