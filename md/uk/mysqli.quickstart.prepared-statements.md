...
Результати з підготовленого запиту можна отримати або прив'язавши вихідні змінні або запросивши об'єкт [mysqli\_result](class.mysqli-result.html)
...
Також можна буферизувати дані результуючих таблиць підготовленого запиту за допомогою функції [mysqli\_stmt::store\_result()](mysqli-stmt.store-result.html)

*Вилучення результатів запиту за допомогою mysqliresult інтерфейсу*

Замість використання прив'язки змінних до результатів запиту, результуючі таблиці можна отримувати засобами інтерфейсу mysqliresult. Функція [mysqli\_stmt::get\_result()](mysqli-stmt.get-result.html) повертає буферизований результуючий набір рядків.
...
Використання інтерфейсу [mysqli\_result](class.mysqli-result.html) має додаткову перевагу в тому, що буферизація результуючих таблиць на клієнті пропонує гнучку систему навігації по цих таблицях.
...
| Підтримує використання API mysqliresult | Так, використовується [mysqli\_stmt::get\_result()](mysqli-stmt.get-result.html) | Так |
| Буферизація результуючих наборів | Їсти, можна використовувати функцію [mysqli\_stmt::get\_result()](mysqli-stmt.get-result.html) або [mysqli\_stmt::store\_result()](mysqli-stmt.store-result.html) | Є, ця поведінка за умовчанням для [mysqli::query()](mysqli.query.html) |
| Робота з небуферизованими результуючими наборами | Можливо, використовується прив'язка вихідних параметрів за допомогою API | Можливо, використовується функція [mysqli::real\_query()](mysqli.real-query.html) спільно з [mysqli::use\_result()](mysqli.use-result.html) |
