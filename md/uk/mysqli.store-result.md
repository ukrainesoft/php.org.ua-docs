...
Надає результуючий набір останнього запиту на з'єднанні `mysql`. Подальша робота з цим набором здійснюється функцією [mysqlidataseek()](mysqli-result.data-seek.md)
...
> **Зауваження**
> 
> Навіть попри гарну практику очищати пам'ять, зайняту результатами запитів, за допомогою функції [mysqlifreeresult()](mysqli-result.free.md), якщо **mysqlistoreresult()** передає великий результуючий набір, може стати проблемою.
