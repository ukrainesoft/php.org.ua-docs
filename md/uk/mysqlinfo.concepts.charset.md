...
Кодування символів має бути чітко визначено, оскільки впливає на кожну дію, у тому числі на дії з наслідками безпеки. Наприклад, механізми екранування (такі як [mysqlirealescapestring()](mysqli.real-escape-string.html) для mysqli та [PDO::quote()](pdo.quote.html) для PDOMySQL) залежить від цих налаштувань. Важливо розуміти, що ці функції не використовують кодування символів, визначене у запиті, наприклад, такі запити не впливатимуть на поведінку цих функцій:
...
**Приклад #3 Приклад встановлення кодування символів: [pdomysql](ref.pdo-mysql.connection.html)**
