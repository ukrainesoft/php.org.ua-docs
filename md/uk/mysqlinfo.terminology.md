...
В документации MySQL, термин*конектор(connector)* відсилає до тієї частини програмного забезпечення, яка дозволяє вашому додатку з'єднатися з базою даних MySQL. MySQL надає конектори для багатьох мов програмування, у тому числі для PHP.
