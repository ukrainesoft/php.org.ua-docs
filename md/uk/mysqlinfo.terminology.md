...
Для прикладу, конектор [PHP Data Objects (PDO)](mysqli.overview.md#mysqli.overview.pdo) може використовувати різні спеціалізовані драйвери для різних баз даних. Один із них "PDO MYSQL driver", призначений для взаємодії з MySQL.
