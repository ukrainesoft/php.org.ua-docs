...
Цей параметр конфігурації включає всю [статистику вбудованого драйвера MySQL](mysqlnd.stats.md), крім що стосується роботи з оперативною
пам'яттю.
...
з оперативною пам'яттю, до загального набору даних [статистики вбудованого драйвера MySQL](mysqlnd.stats.md).
...
запису" за замовчуванням. Дивіться [Реалізація управління пам'яттю](mysqlnd.memory.md) для отримання більшої інформації.
