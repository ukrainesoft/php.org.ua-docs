...
Режим копіювання може бути включений примусово, встановивши [mysqlnd.fetchdatacopy](mysqlnd.config.md#ini.mysqlnd.fetch_data_copy)
...
[Журнал налагодження](mysqlnd.config.md#ini.mysqlnd.debug) може бути налаштований для запису викликів системи керування пам'яттю. Це допомагає побачити коли пам'ять виділяється та звільняється. Однак, розмір запитуваних шматків пам'яті може не бути у списку.
