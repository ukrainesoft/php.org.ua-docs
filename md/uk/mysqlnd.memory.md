...
[буферизовані та небуферизовані](mysqli.quickstart.statements.md) результати.
...
`while ($row = $res->fetch_assoc()) { ... }`, може оптимізувати
...
[mysqlnd.fetch_data_copy](mysqlnd.config.md#ini.mysqlnd.fetch_data_copy)=1.
