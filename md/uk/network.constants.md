...
**Опції [dns\_get\_record()](function.dns-get-record.html)**
...
| **`DNS_HINFO`** | Ресурс Host Info (Дивіться [» `IANA Названия операционных систем`](http://www.iana.org/assignments/operating-system-names) для отримання розшифрування значень)                        |
