...
-   [« Типи ресурсів](network.resources.html)
...
**Опції [openlog()](function.openlog.html)**
...
**Засоби [openlog()](function.openlog.html)**
...
**Пріоритети [syslog()](function.syslog.html) (У порядку спадання)**
...
**Опції [dnsgetrecord()](function.dns-get-record.html)**
