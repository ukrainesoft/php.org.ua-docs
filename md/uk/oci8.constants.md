...
| **`OCI_DESCRIBE_ONLY`** | Режим виконання виразів для [ociexecute()](function.oci-execute.md). Використовуйте цей режим, якщо ви хочете отримати дані про виконання запиту, а не виконати запит. |
...
| **`OCI_FETCHSTATEMENT_BY_COLUMN`** | Режим [ocifetchall()](function.oci-fetch-all.md) за замовчуванням. |
...
| Константа | Описание |
| --- | --- |
| **`OCI_B_BFILE`** | Використовується функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язки змінних типу BFILE. |
| **`OCI_B_BIN`** | Використовується разом із функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язування необроблених (RAW) даних. |
| **`OCI_B_BLOB`** | Використовується функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язки змінних типу BLOB. |
...
| **`OCI_B_ROWID`** | Використовується функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язки змінних типу ROWID. |
| **`SQLT_AFC`** | Використовується функцією [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язки масивів із елементами типу CHAR. |
| **`SQLT_AVC`** | Використовується функцією [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язування масивів з елементами VARCHAR2. |
...
| **`SQLT_LBI`** | Використовується функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язки змінних типу LONG RAW. |
| **`SQLT_LNG`** | Використовується функцією [ocibindбname()](function.oci-bind-by-name.md) для прив'язки змінних типу LONG. |
| **`SQLT_LVC`** | Використовується функцією [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язування масивів із елементами типу LONG VARCHAR. |
| **`SQLT_NTY`** | Те саме, що і **`OCI_B_NTY`** |
| **`SQLT_NUM`** | Те саме, що і **`OCI_B_NUM`** |
| **`SQLT_ODT`** | Використовується функцією [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язування масивів із елементами типу LONG. |
| **`SQLT_RDD`** | Те саме, що і **`OCI_B_ROWID`** |
| **`SQLT_RSET`** | Те саме, що і **`OCI_B_CURSOR`** |
| **`SQLT_STR`** | Використовується функцією [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язки масивів із елементами типу STRING. |
| **`SQLT_UIN`** | Не підтримується. |
| **`SQLT_VCS`** | Використовується спільно з [ocibindarrayбname()](function.oci-bind-array-by-name.md) для прив'язування масивів VARCHAR. |

**Типи дескрипторів OCI8**

| Константа | Описание |
| --- | --- |
| **`OCI_DTYPE_FILE`** | Прапор використовується [ocinewdescriptor()](function.oci-new-descriptor.md) для ініціалізації дескриптора типу FILE |
| **`OCI_DTYPE_LOB`** | Прапор використовується [ocinewdescriptor()](function.oci-new-descriptor.md) для ініціалізації дескриптора типу LOB |
| **`OCI_DTYPE_ROWID`** | Прапор використовується [ocinewdescriptor()](function.oci-new-descriptor.md) для ініціалізації дескриптора типу ROWID |
