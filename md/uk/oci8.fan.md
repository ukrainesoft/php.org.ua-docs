...
Якщо [oci8.events](oci8.configuration.html#ini.oci8.events) встановлено як `On`, то передбачається, що [oci8.ping\_interval](oci8.configuration.html#ini.oci8.ping-interval) встановлено в -1, оскільки включення подій FAN надає проактивне управління очікуваними з'єднаннями.
...
-   Під обліковим записом привілейованого адміністратора баз даних, за допомогою програм типу SQLPlus дозвольте сервісу бази відправляти оповіщення FAN, наприклад:
