...
Якщо [oci8.events](oci8.configuration.html#ini.oci8.events) встановлено як `On`, то передбачається, що [oci8.pinginterval](oci8.configuration.html#ini.oci8.ping-interval) встановлено в -1, оскільки включення подій FAN надає проактивне управління очікуваними з'єднаннями.
