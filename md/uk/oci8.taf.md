...
Реєстрацію функції зворотного дзвінка можна видалити за допомогою [oci\_unregister\_taf\_callback()](function.oci-unregister-taf-callback.html)
...
Ідентифікатор з'єднання Oracle, для якого ця функція була зареєстрована за допомогою [oci\_register\_taf\_callback()](function.oci-register-taf-callback.html). З'єднання недоступне під час аварійного відновлення.
