...
Реєстрацію функції зворотного дзвінка можна видалити за допомогою [ociunregistertafcallback()](function.oci-unregister-taf-callback.html)
...
Ідентифікатор з'єднання Oracle, для якого ця функція була зареєстрована за допомогою [ociregistertafcallback()](function.oci-register-taf-callback.html). З'єднання недоступне під час аварійного відновлення.
