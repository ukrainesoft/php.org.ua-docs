...
Надає колекції значення іншої, раніше створеної колекції. Обидві колекції мають бути створені раніше за допомогою [ocinewcollection()](function.oci-new-collection.md)
