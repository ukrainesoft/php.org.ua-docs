...
Застосовує opcache.file_cache_only=1 для деяких процесів, які
...
Режим ``tracing'' відповідає `CRTO = 1254`, Режим ``function''
відповідає `CRTO=1205`.
...
`opcache.jit=1215`. Докладніше дивіться у розділі
