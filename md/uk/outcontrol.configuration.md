...
Ви можете перенаправити весь висновок вашого скрипта на функцію. Наприклад, якщо ви встановите outputhandler в [мбoutputhandler()](function.mb-output-handler.md), то кодування символів прозоро перетворюється відповідно до зазначеного кодування. Налаштування будь-якого обробника виводу автоматично включає буферизацію виводу.
...
> **Зауваження**
> 
> Тільки вбудовані функції можуть використовуватись із цією директивою. Для функції, визначеної користувачем, використовуйте [проstart()](function.ob-start.md)
...
Зморите також [про implicit flush()](function.ob-implicit-flush.md)
