...
| --- | --- |
| \[...\] | Одиночний символ, що вказаний або міститься у вказаному діапазоні. Діапазони можна комбінувати із операторами `{+}`и`{-}`НаПриклад,`[a-z]{+}[0-9]` те саме, що і `[0-9a-z]`, а`[a-z]{-}[aeiou]` те саме, що і `[b-df-hj-np-tv-z]` |
