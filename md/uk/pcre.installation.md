...
параметр **--with-pcre-regex=DIR**, де `DIR` вказує на директорію з
...
знайти в [» списку змін бібліотеки PCRE](http://www.pcre.org/original/changelog.txt), а також у наступній
історії PCRE:
