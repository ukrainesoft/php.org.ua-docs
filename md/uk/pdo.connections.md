...
У разі виникнення помилки при підключенні буде викинуто виняток `PDOException`. Його можна перехопити та обробити, або залишити на відкуп глобальному обробнику помилок, який ви задали функцією [set\_exception\_handler()](function.set-exception-handler.html)
