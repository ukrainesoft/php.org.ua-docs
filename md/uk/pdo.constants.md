...
Детально про цей атрибут дивіться розділ [Помилки та їх обробка](pdo.error-handling.md).
...
Докладніше про цей атрибут дивіться в розділі [Підключення та керування підключеннями](pdo.connections.md).
...
Докладніше про цей атрибут дивіться в розділі [Помилки та їх обробка](pdo.error-handling.md).
