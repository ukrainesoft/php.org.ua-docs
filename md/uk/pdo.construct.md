...
Загалом, DSN складається з імені драйвера PDO, за яким слідує двокрапка та специфічний синтаксис підключення драйвера PDO. Додаткову інформацію можна отримати з розділу [Документация по специфическим драйверам PDO](pdo.drivers.html)
