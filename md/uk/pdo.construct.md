...
**PDO::construct()** викидає виняток [PDOException](class.pdoexception.md), якщо спроба підключення до бази даних, що запитується, завершується з помилкою, незалежно від того, якою **`PDO::ATTR_ERRMODE`** встановлений на даний момент.
