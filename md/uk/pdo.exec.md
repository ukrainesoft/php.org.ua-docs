...
` <?php$dbh = new PDO('odbc:sample', 'db2inst1', 'ibmdb2');/*¦Видаляємо всі записи з таблиці FRUIT */$count = $dbh->exe| ;/* Отримаємо кількість віддалених записів */print("Видалено $count рядків.
");?> `
