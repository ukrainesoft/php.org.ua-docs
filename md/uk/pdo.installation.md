...
1.  Виберіть DLL конкретних баз даних або завантажувати їх під час виконання функцією [dl()](function.dl.md), або включити їх у php.ini після phppdo.dll. Наприклад:
