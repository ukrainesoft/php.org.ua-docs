...
Якщо СУБД успішно підготувала запит, **PDO::prepare()** повертає об'єкт [PDOStatement](class.pdostatement.md). Якщо підготувати запит не вдалося, **PDO::prepare()** повертає **`false`** або викидає виняток [PDOException](class.pdoexception.md) (залежить від поточного режиму [обработки ошибок](pdo.error-handling.md)
