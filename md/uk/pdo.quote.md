...
Для коректної роботи **PDO::quote()** набір символів має бути заданий або сервері, або задаватися самим з'єднанням з базою даних (залежить від драйвера). Детальніше дивіться [документацію до драйвера бази даних](pdo.drivers.html)
