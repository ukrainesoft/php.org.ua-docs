...
У цьому прикладі припустимо, що ми створюємо кілька записів для нового співробітника з номером ID 23. Крім введення основний інформації необхідно записати його зарплату. Досить просто зробити два окремі оновлення таблиць, проте шляхом укладання цих запитів у рамки [PDO::beginTransaction()](pdo.begintransaction.html) і [PDO::commit()](pdo.commit.md) ми зможемо гарантувати, що ніхто не побачить цих змін, доки всі вони не будуть завершені. Якщо щось піде не так, catch-блок відкотить усі зміни з початку транзакції та надрукує повідомлення про помилку.
