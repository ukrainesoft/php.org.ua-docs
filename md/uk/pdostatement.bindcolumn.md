...
> 
> Однак, при роботі з *драйвером PgSQL*, коли прив'язується стовпець з LOB-даними, додатком необхідно викликати цей метод *до* виклику [PDOStatement::execute()](pdostatement.execute.md). В іншому випадку ідентифікатор великого об'єкта OID матиме тип integer.
