...
Витягує наступний рядок і повертає його у вигляді об'єкта. Цей метод є альтернативою виклику [PDOStatement::fetch()](pdostatement.fetch.md) з параметром **`PDO::FETCH_CLASS`** або **`PDO::FETCH_OBJ`**
