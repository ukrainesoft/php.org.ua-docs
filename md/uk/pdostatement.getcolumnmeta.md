...
Деякі драйвери PDO можуть не реалізувати функції **PDOStatement::getColumnMeta()**оскільки вона є необов'язковою. Однак усі [драйверы PDO](pdo.drivers.html), зазначені в посібнику, реалізують цю функцію.
...
| `pdo_type`         | Тип PDO значення стовпця у вигляді однієї з констант [`PDO::PARAM_*`](pdo.constants.html)                                                                                                               |
