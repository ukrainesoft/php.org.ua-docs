...
Деякі драйвери PDO можуть не реалізувати функції \*\*PDOStatement::getColumnMeta()\*\*оскільки вона є необов'язковою. Однак усі [драйвери PDO](pdo.drivers.html), зазначені в посібнику, реалізують цю функцію.
