...
**Пример #1 Пример использования**Phar::buildFromIterator()\*\* з об'єктами SplFileInfo\*\*
...
**Пример #2 Пример использования**Phar::buildFromIterator()\*\* з іншими типами ітераторів\*\*
