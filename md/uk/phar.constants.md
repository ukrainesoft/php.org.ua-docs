...
| **`Phar::PHPS`**(int) |  | використовується для вказівки параметра перевизначення MIME-типу [Phar::webPhar()](phar.webphar.md), відповідно до якого розширення має бути розібране як вихідний файл PHP за допомогою [highlight\_file()](function.highlight-file.md) |
