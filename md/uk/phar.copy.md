...
У цьому прикладі показано використання методу **Phar::copy()** і еквівалентної йому за функціональністю обгортки потоку для вирішення однієї і тієї ж задачі. Основною відмінністю між цими двома підходами є обробка помилок. Усі методи Phar викидають винятки, тоді як обгортка потоку використовує [trigger\_error()](function.trigger-error.html)
