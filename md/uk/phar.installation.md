...
Модуль може бути встановлений із репозиторію PECL. Докладніші відомості та історія версій доступні на [» сторінці Phar у репозиторії PECL](https://pecl.php.net/package/phar)