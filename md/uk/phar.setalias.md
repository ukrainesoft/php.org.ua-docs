...
Викидає виняток [UnexpectedValueException](class.unexpectedvalueexception.html), якщо доступ заборонено та [PharException](class.pharexception.html)якщо псевдонім вже використовується, або виникли проблеми із записом на диск.
