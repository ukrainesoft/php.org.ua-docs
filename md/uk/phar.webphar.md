...
Якщо ви використовуєте fast-cgi або cgi, то параметром, що передається в цю функцію, буде значення змінної [SERVER\['PATHINFO'\]](reserved.variables.server.html). В іншому випадку буде передаватися значення змінної [SERVER\['REQUESTURI'\]](reserved.variables.server.html)
