...
Для архівів типу Zip цей метод викине виняток. Для розтискання gzip-архівів має бути включений модуль [zlib](ref.zlib.md), а для bzip2, відповідно, модуль [bzip2](ref.bzip2.md)
...
Повертає об'єкт типу [PharData](class.phardata.md) у разі успішного виконання та **`null`** у разі виникнення помилки.
