...
Викидає [BadMethodCallException](class.badmethodcallexception.md), якщо INI-опція [phar.readonly](phar.configuration.md#ini.phar.readonly) увімкнено, або якщо відповідний модуль [bzip2](ref.bzip2.md) [zlib](ref.zlib.md)недоступен.
