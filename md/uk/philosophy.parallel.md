...
Ця філософія, якої дотримується parallel, бере свій початок з Go, однієї з найпопулярніших платформ, що використовуються для написання паралельного коду в даний час. Програмісти на Go повинні наполегливо працювати, щоб відповідати цьому ідеалу: PHP і паралельний інтерфейс роблять всю важку роботу за програміста, причому за замовчуванням.
