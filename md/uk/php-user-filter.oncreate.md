...
| `FilterClass->params` | Вміст аргументу `params` передається у функцію [streamfilterappend()](function.stream-filter-append.md) або [streamfilterprepend()](function.stream-filter-prepend.md) |
