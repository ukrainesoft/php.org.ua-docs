...
Для використання цих функцій необхідно встановити пакет libreadline. Знайти його можна на домашній сторінці проекту [» http://cnswww.cns.cwru.edu/~chet/readline/rltop.md](http://cnswww.cns.cwru.edu/~chet/readline/rltop.md). Він підтримується автором Bash Четом Ремі (Chet Ramey).
