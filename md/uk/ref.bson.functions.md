...
-   [MongoDBBSONfromJSON](function.mongodb.bson-fromjson.md) — Повертає уявлення BSON значення JSON
...
-   [MongoDBBSONtoJSON](function.mongodb.bson-tojson.md) — Повертає Legacy Extended JSON представлення значення BSON
