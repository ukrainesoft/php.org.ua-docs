...
Інші математичні функції можна знайти у розділі [Математичні модулі](refs.math.html)

## Зміст

-   [gmpabs](function.gmp-abs.html) - Абсолютна величина
-   [gmpadd](function.gmp-add.html) — Складання чисел
...
-   [gmpdivгр](function.gmp-div-qr.html) — Розподіл чисел та отримання приватного та залишку
