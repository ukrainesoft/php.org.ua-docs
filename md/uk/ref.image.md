...
-   [image\_type\_to\_extension](function.image-type-to-extension.md)— Розширення файлу для типу зображення
...
-   [imageflip](function.imageflip.md)— Перетворення зображення за допомогою вибраного режиму.
...
-   [imageistruecolor](function.imageistruecolor.md)— Визначає, чи зображення є повнокольоровим.
...
-   [png2wbmp](function.png2wbmp.md)— Перетворює файл PNG на файл WBMP
