...
Наступні константи використовуються для отримання інформації схеми. Можуть використовуватись із функцією [PDO::cubridschema()](pdo.cubrid-schema.html)
