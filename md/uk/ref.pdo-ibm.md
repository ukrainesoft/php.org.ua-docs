...
Client версії v9.1 або вище. DB2 Client можна завантажити з сайту [» сайту розробки додатків IBM](http://www.ibm.com/software/data/db2/ad).
...
> DB2 UDB для z/OS, використовуючи окремо куплений [» продукт DB2 > Connect](http://www.ibm.com/software/data/db2/db2connect).
