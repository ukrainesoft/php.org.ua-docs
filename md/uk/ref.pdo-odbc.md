...
PDOODBC – драйвер, що реалізує [интерфейс PHP Data Objects (PDO)](intro.pdo.md) для доступу до баз даних через драйвер ODBC або бібліотеку IBM DB2 Call Level Interface (DB2 CLI). На даний момент PDOODBC підтримує різні "відтінки" драйверів баз даних:
