...
Це налаштування можна змінити тільки в php.ini та впливає на всі процеси; всі модулі, завантажені в процес і які використовують ті ж бібліотеки ODBC, залежатимуть від цієї настройки, включаючи [Унифицированный модуль ODBC](ref.uodbc.html)
...
Це налаштування можна змінити тільки в php.ini, і воно впливає на всі процеси; всі модулі, завантажені в процес і які використовують ті ж бібліотеки ODBC, залежатимуть від цієї настройки, включаючи [унифицированный модуль ODBC](ref.uodbc.html)
