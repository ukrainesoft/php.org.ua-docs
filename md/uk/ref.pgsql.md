...
-   [pg\_insert](function.pg-insert.html) — Заносить дані з масиву до таблиці баз даних
...
-   [pg\_lo\_tell](function.pg-lo-tell.html) — Повертає поточне положення внутрішнього покажчика великого об'єкту
...
-   [pg\_send\_query\_params](function.pg-send-query-params.html) — Надсилає параметризований запит на сервер, не чекає результату, що повертається.
