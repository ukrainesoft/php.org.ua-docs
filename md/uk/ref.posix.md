...
Також може бути корисним розділ "[Функції керування процесами](book.pcntl.html)".
...
-   [posixgetgrgid](function.posix-getgrgid.html) — Повертає інформацію про групу щодо її ID
