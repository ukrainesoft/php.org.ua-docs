...
-   [snmpsetenumprint](function.snmp-set-enum-print.html) — Повертає всі значення, які є перерахуваннями, із їх значенням перерахування замість необробленого цілого числа
