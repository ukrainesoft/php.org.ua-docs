...
-   [snmpsetenumprint](function.snmp-set-enum-print.md) — Повертає всі значення, які є перерахуваннями, із їх значенням перерахування замість необробленого цілого числа
