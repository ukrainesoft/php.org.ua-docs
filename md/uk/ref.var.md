...
-   [ісnumeric](function.is-numeric.html) — Перевіряє, чи є змінна числом чи рядком, який містить число
...
-   [varexport](function.var-export.html) — Виводить або повертає інтерпретоване строкове подання змінної
