...
Регулярний вираз - це шаблон, з яким порівнюється вказаний рядок зліва направо. Більшість символів у шаблоні є собою, і збігаються з відповідними символами в рядку. Як банальний приклад, шаблон `The quick brown fox` відповідає тій частині рядка, що з ним збігається.
