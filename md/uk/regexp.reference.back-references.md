...
Однак, якщо наступне за зворотним слешем число менше 10, воно завжди інтерпретується як зворотне посилання, і призводить до помилки тільки в тому випадку, якщо немає відповідного числа дужок, що відкривають. Інакше кажучи, відкриваючі дужки нічого не винні передувати засланню чисел менше 10. " Випереджальна зворотна посилання " може мати сенс, якщо використовується повторення і більш пізня підмаска бере участь у ранній итерации. Дивіться розділ [escape-послідовності](regexp.reference.escape.html) для отримання додаткових відомостей про обробку цифр, що йдуть за зворотним слішем.
...
На ту саму підмаску може бути кілька посилань. Якщо підмаска не брала участі в зіставленні, то зіставлення з посиланням на неї завжди зазнає невдачі. Наприклад, шаблон `(a|(bc))\2` зазнає невдачі, якщо знаходить відповідність з "a" раніше, ніж з "bc". Оскільки може бути до 99 зворотних посилань, всі цифри, що йдуть за зворотним слешем, розглядаються як частина потенційного зворотного посилання. Якщо за посиланням має йти цифра, необхідно використовувати обмежувач. У випадку, якщо вказано прапор [PCREEXTENDED](reference.pcre.pattern.modifiers.html), обмежувачем може бути будь-який символ пробілу. Інакше можна використовувати порожній коментар.
