...
Якщо використовується модифікатор [PCREEXTENDED](reference.pcre.pattern.modifiers.md), неекранований символ '#' поза символьним класом також означає початок блоку коментаря, який триває до кінця поточного рядка.
