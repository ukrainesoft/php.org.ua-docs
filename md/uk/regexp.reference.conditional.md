...
Умови бувають двох видів. Якщо між дужками укладено цифри, умова буде виконуватися в тому випадку, якщо підмаска з відповідним номером була успішно зіставлена. Розглянемо наступний шаблон (він містить незначну прогалину для зручності читання, мається на увазі використання модифікатора [PCREEXTENDED](reference.pcre.pattern.modifiers.md)), розділивши його для зручності на три смислові частини:
