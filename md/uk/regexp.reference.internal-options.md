...
Установки [PCRE\_CASELESS](reference.pcre.pattern.modifiers.html) [PCRE\_MULTILINE](reference.pcre.pattern.modifiers.html) [PCRE\_DOTALL](reference.pcre.pattern.modifiers.html) [PCRE\_UNGREEDY](reference.pcre.pattern.modifiers.html) [PCRE\_EXTRA](reference.pcre.pattern.modifiers.html) [PCRE\_EXTENDED](reference.pcre.pattern.modifiers.html) та PCREDUPNAMES можуть бути локально визначені в шаблоні з використанням спеціальних Perl-послідовностей між символами "(?" і ")". Нижче наведено список цих опцій:
...
Наприклад, (?im) вказує на реєстронезалежний, багаторядковий режим пошуку. Також можна скинути опцію, поставивши перед нею символ '-', або комбінувати установку та скасування режимів. Наприклад, (?im-sx) встановлює прапори [PCRE\_CASELESS](reference.pcre.pattern.modifiers.html) [PCRE\_MULTILINE](reference.pcre.pattern.modifiers.html) та скасовує прапори [PCRE\_DOTALL](reference.pcre.pattern.modifiers.html) і [PCRE\_EXTENDED](reference.pcre.pattern.modifiers.html). У випадку, якщо символ розташований одночасно після та перед символом '-', опція буде скасована.
