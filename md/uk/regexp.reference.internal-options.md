...
Установки [PCRECASELESS](reference.pcre.pattern.modifiers.html) [PCREMULTILINE](reference.pcre.pattern.modifiers.html) [PCREDOTALL](reference.pcre.pattern.modifiers.html) [PCREUNGREEDY](reference.pcre.pattern.modifiers.html) [PCREEXTRA](reference.pcre.pattern.modifiers.html) [PCREEXTENDED](reference.pcre.pattern.modifiers.html) та PCREDUPNAMES можуть бути локально визначені в шаблоні з використанням спеціальних Perl-послідовностей між символами "(?" і ")". Нижче наведено список цих опцій:
...
Наприклад, (?im) вказує на реєстронезалежний, багаторядковий режим пошуку. Також можна скинути опцію, поставивши перед нею символ '-', або комбінувати установку та скасування режимів. Наприклад, (?im-sx) встановлює прапори [PCRECASELESS](reference.pcre.pattern.modifiers.html) [PCREMULTILINE](reference.pcre.pattern.modifiers.html) та скасовує прапори [PCREDOTALL](reference.pcre.pattern.modifiers.html) і [PCREEXTENDED](reference.pcre.pattern.modifiers.html). У випадку, якщо символ розташований одночасно після та перед символом '-', опція буде скасована.
