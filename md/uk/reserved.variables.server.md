...
присутні в [» специфікації CGI/1.1](http://www.faqs.org/rfcs/rfc3875), так що ви можете очікувати їх
наявність.
...
`http://example.com/foo/bar.php` буде `/foo/bar.php`. Константа [\_\_FILE\_\_](language.constants.predefined.md) містить повний шлях
...
> **Примітка**: В Apache 2 ви повинні встановити `UseCanonicalName = On`
...
> необхідно встановити `UseCanonicalName = On` та
> `UseCanonicalPhysicalPort = On`, інакше це значення може бути
...
> `AcceptPathInfo = On` у конфігураційному файлі `httpd.conf` для
...
`http://www.example.com/php/path_info.php/some/stuff?foo=bar`, то
