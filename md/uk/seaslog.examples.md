...
За замовчуванням шаблон: *seaslog.defaulttemplate = "% T | % L | % P | % Q | % t | % M"*. Це означає, що за замовчуванням стиль запису журналу： {dateTime} | {Level} | {pid} | {uniqid} | {timeStamp} | {logInfo}
