...
navigation:
  - security.md: « Безпека
  - security.general.md: Общие рассуждения »
  - index.md: PHP Manual
  - security.md: Безпека
title: Вступ
---
