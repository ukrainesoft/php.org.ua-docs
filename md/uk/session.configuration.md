...
Можливо вказати будь-який з алгоритмів, передбачених [модулем hash](ref.hash.md)(если он доступен), например,`sha512`или`whirlpool`. Повний список алгоритмів можна отримати за допомогою функції [hash\_algos()](function.hash-algos.md)
