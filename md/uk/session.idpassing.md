...
відповідну сесійну cookie, SID має вигляд `session_name=session_id`. В
...
` <?phpsession_start();if(empty($_SESSION['count'])) {   $_SESSION['count'] = 1;} else {  $_SESSION['count']++;}?><p> Здрастуйте, відвідувач, ви бачили цю сторінку <?php echo $_SESSION['count']; ?> раз.</p><p><a href="nextpage.php?<?php echo htmlspecialchars(SID); ?>">Натиснітьсюди</a>, щоб продовжити.</p>`
