...
> **Зауваження** :
> 
> Директива[arg\_separator.output](ini.core.md#ini.arg-separator.output) із php.ini дозволяє налаштовувати роздільник аргументів. Для повної сумісності із XHTML слід вказувати &.
...
Функция[htmlspecialchars()](function.mdspecialchars.md) може використовуватися для виведення \*\*`SID`\*\*с целью предотвращения XSS-атак.

Висновок **`SID`** способом, наведеним вище, не є обов'язковим, якщо опція [\--enable-trans-sid](session.configuration.md#ini.session.use-trans-sid) була використана при компіляції PHP.
