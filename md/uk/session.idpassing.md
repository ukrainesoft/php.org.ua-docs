...
> **Зауваження**
> 
> Директива [argseparator.output](ini.core.md#ini.arg-separator.output) із php.ini дозволяє налаштовувати роздільник аргументів. Для повної сумісності із XHTML слід вказувати &.
