...
> **Зауваження**
> 
> Директива [argseparator.output](ini.core.html#ini.arg-separator.output) із php.ini дозволяє налаштовувати роздільник аргументів. Для повної сумісності із XHTML слід вказувати &.
