---
navigation:
  - simdjson.requirements.md: « Вимоги
  - simdjson.constants.md: Обумовлені константи »
  - index.md: PHP Manual
  - simdjson.setup.md: Встановлення та налаштування
title: Установка
