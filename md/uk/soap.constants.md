...
| **`SOAP_ENCODED`** (int) |  | Визначає використання кодування SOAP при передачі як параметр `use` методом [SoapClient::construct()](soapclient.construct.md) |
| **`SOAP_LITERAL`** (int) |  | Визначає використання специфічного для сервісу кодування при передачі як параметр `use` методом [SoapClient::construct()](soapclient.construct.md) |
| **`SOAP_RPC`** (int) |  | Визначає використання прив'язки в стилі RPC при передачі як параметр `style` методом [SoapClient::construct()](soapclient.construct.md) |
| **`SOAP_DOCUMENT`** (int) |  | Визначає використання прив'язки до документа при передачі як параметр `style` методом [SoapClient::construct()](soapclient.construct.md) |
| **`SOAP_ACTOR_NEXT`** (int) |  |  |
| **`SOAP_ACTOR_NONE`** (int) |  |  |
