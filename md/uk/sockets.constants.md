...
Ця константа доступна лише на платформах, які підтримують опцію **`SO_REUSEPORT`** сокету: сюди входять Linux, macOS та BSD, але Windows не входить.
