...
- Додає поле, яке використовуватиметься для угруповання
результатів
...
SolrQuery::addGroupField — Додає поле, яке буде використовуватись
для угруповання результатів
...
Ім'я поля, яким групуються результати. Поле має бути
однозначним або індексуватися, або мати тип поля, який має
джерело значення та працює у запиті функції, наприклад,
ExternalFileField. Це також має бути рядкове поле, таке як
StrField або TextField Використовує параметр group.field
