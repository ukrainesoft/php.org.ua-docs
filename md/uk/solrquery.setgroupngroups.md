...
-   [« SolrQuery::setGroupMain](solrquery.setgroupmain.html)
...
SolrQuery::setGroupNGroups — Якщо true, Solr включає кількість груп, які відповідають запиту.
...
Якщо true, Solr включає кількість груп, які відповідають запиту.
