...
> **Зауваження**: SQLite3, можливо, потрібно створити [» временные файлы](https://sqlite.org/tempfiles.html) під час виконання запитів, тому відповідні директорії повинні бути доступні для запису.
