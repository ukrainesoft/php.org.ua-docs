...
Функція [ssh2authagent()](function.ssh2-auth-agent.md) доступна лише з версією libssh >= 1.2.3.

Підтримка канальних потоків у [streamsettimeout()](function.stream-set-timeout.md) доступна лише з версією libssh >= 1.2.9.
