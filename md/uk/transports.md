...
Нижченаведений список містить інформацію про протоколи передачі, вбудовані в PHP і готові для використання функціями роботи з сокетами, такими як [fsockopen()](function.fsockopen.md) і [streamsocketclient()](function.stream-socket-client.md). Ці протоколи *не* застосовуються в [модулях для роботи із Сокетами](ref.sockets.md)

Для отримання списку підтримуваних протоколів передачі, вбудованих у вашу версію PHP, використовуйте функцію [streamgettransports()](function.stream-get-transports.md)
