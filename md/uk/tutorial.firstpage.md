...
все ж таки залишилися, не соромтеся попросити допомоги одним з [» множини доступних способів](https://www.php.net/support.php) отримання підтримки
з PHP.
...
Докладніше про це можна прочитати в розділі [Основний синтаксис](language.basic-syntax.md).
...
> PHP. Список деяких редакторів міститься у розділі [» Список > редакторів PHP](http://en.wikipedia.org/wiki/List_of_PHP_editors).
