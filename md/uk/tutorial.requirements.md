...
простим способом. У нашому посібнику є [інструкції з встановлення PHP](install.md) (передбачається, що ви вже встановили веб-сервер).
Якщо у вас виникли проблеми під час встановлення PHP, ми пропонуємо вам задати
питання у нашому [» списку розсилки з питань установки](https://www.php.net/mailing-lists.php). Якщо ж ви обрали
простіший спосіб, то [» знайдіть вже налаштований пакет](http://wikipedia.org/wiki/List_of_AMP_packages) для вашої
