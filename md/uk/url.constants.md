...
Наступні константи доступні для використання з [parseurl()](function.parse-url.html)
...
Наступні константи призначені для використання з [httpbuildquery()](function.http-build-query.html)
