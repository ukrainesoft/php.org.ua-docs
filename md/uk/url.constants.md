...
Наступні константи доступні для використання з [parse\_url()](function.parse-url.html)
...
Наступні константи призначені для використання з [http\_build\_query()](function.http-build-query.html)
