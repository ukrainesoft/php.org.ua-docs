...
Одним із найпоширеніших способів уникнути конфліктів класів та функцій, це визначати їх у своєму власному, окремому [просторі імен](language.namespaces.html)
...
> 
> Згідно правил [області видимості](language.variables.scope.html) у PHP змінні, визначені всередині функцій та класів не можуть конфліктувати зі змінними, заданими у глобальній області видимості.