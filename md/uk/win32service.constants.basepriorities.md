...
navigation:
  ...
  - win32service.constants.recovery-action.md: Дії при відновленні Win32
  - index.md: PHP Manual
...
| --- | --- | --- |
| **`WIN32_ABOVE_NORMAL_PRIORITY_CLASS`** | 0x00008000 | Процес має пріоритет вище за WIN32\_NORMAL\_PRIORITY\_CLASS, але нижче WIN32\_HIGH\_PRIORITY\_CLASS. |
| **`WIN32_BELOW_NORMAL_PRIORITY_CLASS`** | 0x00004000 | Процес має пріоритет вище за WIN32\_IDLE\_PRIORITY\_CLASS, але нижче WIN32\_NORMAL\_PRIORITY\_CLASS. |
