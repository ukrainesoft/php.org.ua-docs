...
| **`WIN32_SERVICE_ACCEPT_PAUSE_CONTINUE`** | 0x00000002 | Служба може бути припинена та продовжена. Цей код дозволяє службі приймати повідомлення **`WIN32_SERVICE_CONTROL_PAUSE`**и**`WIN32_SERVICE_CONTROL_CONTINUE`** |
