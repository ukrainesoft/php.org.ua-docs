...
| **`WIN32_ERROR_INVALID_SERVICE_ACCOUNT`** | 0x00000421 | Ім'я облікового запису користувача, вказане в `user` Відсутнє. Дивіться [win32\_create\_service()](function.win32-create-service.html) |
