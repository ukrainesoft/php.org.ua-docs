...
Для налаштування використання оброблювача сесій WinCache змініть у файлі php.ini налаштування [session.savehandler](session.configuration.html#ini.session.save-handler) на *wincache*. За умовчанням, для зберігання цих сесій використовується тимчасова директорія Windows. Щоб змінити шлях до сесійного файлу, використовуйте налаштування [session.savepath](session.configuration.html#ini.session.save-path)
