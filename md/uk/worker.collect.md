...
Складальник типу Callable, який має повертати **`true`**или**`false`** залежно від цього, чи можна зібрати завдання. Випадки, коли вам може знадобитися власний збирач, дуже рідкісні.
