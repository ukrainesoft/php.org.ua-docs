...
У деяких функціях, таких як [fopen()](function.fopen.html) і [file\_get\_contents()](function.file-get-contents.html), пошук файлу може додатково проводитися в `include_path`
