...
У деяких функціях, таких як [fopen()](function.fopen.md) і [filegetcontents()](function.file-get-contents.md), пошук файлу може додатково проводитися в `include_path`
