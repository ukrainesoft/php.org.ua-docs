...
Цей потік також дозволяє отримати доступ до *вмісту* ресурсу; заголовки зберігаються у змінній [$httpresponseheader](reserved.variables.httpresponseheader.html)
