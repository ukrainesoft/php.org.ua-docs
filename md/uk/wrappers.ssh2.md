...
|-------------------------------------------------------------------------------------|------------|-----------|-------------|-----------------------------------|----------|
| Обмеження по [allow\_url\_fopen](filesystem.configuration.html#ini.allow-url-fopen) | Так        | Так       | Так         | Так                               | Так      |
...
| Підтримка [stat()](function.stat.html)                                              | Ні         | Ні        | Ні          | Так                               | Ні       |
| Підтримка [unlink()](function.unlink.html)                                          | Ні         | Ні        | Ні          | Так                               | Ні       |
| Підтримка [rename()](function.rename.html)                                          | Ні         | Ні        | Ні          | Так                               | Ні       |
| Підтримка [mkdir()](function.mkdir.html)                                            | Ні         | Ні        | Ні          | Так                               | Ні       |
| Підтримка [rmdir()](function.rmdir.html)                                            | Ні         | Ні        | Ні          | Так                               | Ні       |
...
unset() закриває сесію, тому що $connectionstring не є посиланням на змінну $session, лише її текстовим уявленням. Це також відбувається і у разі неявного виклику [unset()](function.unset.html) при виході з області видимості (наприклад, функції).